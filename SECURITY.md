...
![trust](https://img.shields.io/badge/trust-membrane-blue)
![review](https://img.shields.io/badge/review-required-yellow)

**Quick jumps**  
[Purpose](#purpose) ·
[Scope](#what-counts-as-a-security-issue-in-kfm) ·
[Repo fit](#repo-fit-and-placement) ·
[Report a vulnerability](#report-a-vulnerability) ·
[Good-faith research](#good-faith-research-and-disclosure-boundaries) ·
[Supported scope](#supported-scope-and-release-posture) ·
[Checklist](#security-affecting-change-checklist) ·
[FAQ](#faq)
...
| **Related** | [README.md](README.md) · [CONTRIBUTING.md](CONTRIBUTING.md) · [.github/CODEOWNERS](.github/CODEOWNERS) · [.github/README.md](.github/README.md) · [.github/SECURITY.md](.github/SECURITY.md) |
...
**Canonical path:** `REVIEW-REQUIRED`  
**Likely candidates:** `./SECURITY.md` or `.github/SECURITY.md`  
**Upstream references:** [README.md](README.md) · [CONTRIBUTING.md](CONTRIBUTING.md) · [.github/CODEOWNERS](.github/CODEOWNERS)  
**Downstream references:** `.github/README.md`, release manifests, policy bundles, runbooks, correction notices, and deployment or recovery procedures

> [!NOTE]
> Keep one canonical source of truth for this policy. If both `./SECURITY.md` and `.github/SECURITY.md` exist, one should clearly delegate to the other to avoid drift.
...
- secrets exposure, dependency or build compromise, supply-chain risk, or unsafe runtime or deployment configuration
...
- rights, sensitivity, location-exposure, or redaction or generalization failures that could expose protected or over-precise information
...
| **Truth path** | Public and internal trust-bearing outputs stay downstream of intake, validation, catalog closure, policy, review, release state, and correction. |
...
flowchart LR
    ...
    E -- Yes --> G[Contain, mitigate, or restrict]
