...
[`tools/local_data/manage.py`](../../../../tools/local_data/manage.py).
`fetch.py` in this package performs no filesystem writes or source admission;
it is an unimplemented boundary stub. `admit.py` remains unimplemented; the
