...
REQUIRED_LAYER20_KEYS=["snapshot_preservation_receipt","snapshot_preservation_scope_plan","snapshot_preservation_classification_matrix","snapshot_preservation_fixity_plan","snapshot_preservation_access_review_plan","snapshot_preservation_minimization_review_plan","snapshot_preservation_hold_candidate_plan","snapshot_preservation_risk_register","snapshot_preservation_policy_continuity_matrix","snapshot_preservation_caveat_register","snapshot_preservation_non_execution_attestation"]
L20_DENIED_TRUE_FIELDS=["publication_allowed","public_release_allowed","preservation_actions_executed","preservation_copy_executed","preservation_transfer_executed","snapshot_export_executed","snapshot_copy_executed","snapshot_transfer_executed","snapshot_published","snapshot_released","archive_transfer_allowed","file_deletion_allowed","legal_hold_creation_allowed","official_archive_certification_allowed","command_execution_allowed","final_accession_execution_allowed","task_closure_allowed"]
EVIDENCE_TYPES=["SCOPE_REVIEW_NOTE","CLASSIFICATION_REVIEW_NOTE","FIXITY_REVIEW_NOTE","LAYOUT_REVIEW_NOTE","ACCESS_REVIEW_NOTE","MINIMIZATION_REVIEW_NOTE","HOLD_CANDIDATE_REVIEW_NOTE","RISK_REVIEW_NOTE","MANUAL_SNAPSHOT_PRESERVATION_REVIEW_ATTESTATION"]
INTERNAL_DISCLAIMER="Internal-only manual snapshot preservation review"
FORBIDDEN_TEXT_TERMS=("preservation execution","preservation copy","preservation transfer","snapshot export","snapshot copy","snapshot transfer","publication approved","public release","file deletion","legal hold","legal advice","official certification")
