# Viewing Product Census Comparison

**Status:** PROPOSED scaffold.  
**Source:** `docs/domains/settlements-infrastructure/EXPANSION_BACKLOG.md`  
**Referenced path:** `contracts/domains/settlements-infrastructure/viewing-product-census-comparison.md`
