# Route Uncertainty Profile

**Status:** PROPOSED scaffold.  
**Source:** `docs/domains/roads-rail-trade/MISSING_OR_PLANNED_FILES.md`  
**Referenced path:** `contracts/domains/roads-rail-trade/route_uncertainty_profile.md`
