...
11. `ABSTAIN / HELD_EVIDENCE` must declare `trust_state.review: PENDING` and `trust_state.release: UNRELEASED`; a held item cannot simultaneously claim completed review or release.
