...
notes:
  ...
  - "If the unresolved-alias projection is unavailable, malformed, a symlink, or lacks the exact v1/domain_lane_register/machine_projection_only authority envelope, the helper fails closed as VALIDATOR_SYSTEM_ERROR with DOMAIN_ALIAS_REGISTER_UNAVAILABLE."
