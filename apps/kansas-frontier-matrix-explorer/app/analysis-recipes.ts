...
export const ANALYSIS_RECIPES: readonly AnalysisRecipe[] = Object.freeze([
  Object.freeze({
    ...
    year: 2026,
    layerIds: Object.freeze(["kansas-extent", "watershed-context", "water-context", "prairie-context", "atmosphere-observations", "communities", "transport-context"]),
  ...
  Object.freeze({
    ...
    year: 2026,
    layerIds: Object.freeze(["kansas-extent", "watershed-context", "water-context", "agriculture-context", "communities", "transport-context"]),
  ...
  Object.freeze({
    ...
    year: 2026,
    layerIds: Object.freeze(["kansas-extent", "watershed-context", "water-context", "communities"]),
  ...
  Object.freeze({
    ...
    year: 2026,
    layerIds: Object.freeze(["kansas-extent", "watershed-context", "smoke-context", "atmosphere-observations", "communities"]),
  ...
  Object.freeze({
    ...
    year: 2026,
    layerIds: Object.freeze(["kansas-extent", "watershed-context", "water-context", "elevation-concept", "communities"]),
    center: Object.freeze([-98.38, 38.48]) as readonly [number, number],
    zoom: 5.8,
    basemap: "prairie",
    scope: "VISIBLE_LAYERS",
  ...
  Object.freeze({
    ...
    year: 2026,
    layerIds: Object.freeze(["kansas-extent", "agriculture-context", "watershed-context", "water-context", "prairie-context", "communities", "transport-context"]),
