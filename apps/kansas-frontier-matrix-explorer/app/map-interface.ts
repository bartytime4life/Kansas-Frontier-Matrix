...
export const MAPLIBRE_REPOSITORY_STATUS = Object.freeze([
  ...
  Object.freeze({ id: "dependency", label: "Dependency admission", state: "EXACT 6.9.0", detail: "The private @kfm/maplibre workspace package and pnpm lock admit exact maplibre-gl 6.9.0." }),
