    ...
    <main className="about-content">
      ...
      <section className="about-section">
        ...
        <div className="about-boundary">
          ...
          <article><h3>Site-local runtime</h3><ul><li>Package-owned NullMapRuntime; MapLibre consumer migration remains held</li><li>Local GeoJSON demonstration fixtures</li><li>No direct model endpoint or live operational source</li><li>No release, deployment, promotion, or publication authority</li></ul></article>
        </div>
      </section>
