...
test("adds bounded renderer-neutral smoke, water, elevation, tile, and scene navigation features", async () => {
  ...
  assert.doesNotMatch(runtime, /setElevationExaggeration|maplibre-gl|addSource|addLayer/);
  assert.match(page, /SCENE \+ TILE LAB/);
  ...
  assert.doesNotMatch(page, /NavigationControl|from "maplibre-gl"|new maplibregl/);
