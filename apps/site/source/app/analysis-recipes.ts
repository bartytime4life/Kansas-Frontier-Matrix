...
export const ANALYSIS_RECIPES: readonly AnalysisRecipe[] = Object.freeze([
  ...
  Object.freeze({
    id: "living-systems",
    eyebrow: "ECOLOGY",
    title: "Living systems context",
    summary: "Compare coarse habitat, fauna guild, flora community, prairie, and water concepts while protected occurrences remain absent or denied.",
    year: 2026,
    layerIds: Object.freeze(["kansas-extent", "county-starter-points", "watershed-context", "water-context", "prairie-context", "habitat-connectivity", "fauna-range-context", "flora-communities", "communities"]),
    center: Object.freeze([-98.38, 38.48]) as readonly [number, number],
    zoom: 5.55,
    basemap: "prairie",
    scope: "VISIBLE_LAYERS",
  ...
  Object.freeze({
    id: "fire-smoke-hazards",
    eyebrow: "HAZARDS",
    title: "Fire, smoke + hazards context",
    summary: "Review synthetic fire, smoke, drought, wind, and flood envelopes beside water and settlements without current-condition or life-safety claims.",
    year: 2026,
    layerIds: Object.freeze(["kansas-extent", "county-starter-points", "watershed-context", "water-context", "smoke-context", "fire-context", "hazards-context", "communities"]),
    center: Object.freeze([-97.55, 38.45]) as readonly [number, number],
    zoom: 5.75,
    basemap: "midnight",
    scope: "VISIBLE_LAYERS",
    detail: "TECHNICAL",
  ...
  Object.freeze({
    id: "people-routes-settlements",
    eyebrow: "GOVERNANCE",
    title: "People, routes + settlements",
    summary: "Inspect aggregate-only people governance with labeled settlements and distinct road and rail context; person-level and DNA detail stays unavailable.",
    year: 2026,
    layerIds: Object.freeze(["kansas-extent", "county-starter-points", "people-dna-context", "transport-context", "communities"]),
    center: Object.freeze([-98.2, 38.55]) as readonly [number, number],
    zoom: 5.8,
    basemap: "prairie",
    scope: "VISIBLE_LAYERS",
    detail: "TECHNICAL",
