...
export const SOURCE_ADMISSION_BY_ID: Readonly<Record<string, SourceAdmissionState>> = Object.freeze({
  ...
  "SRC-CAND-KSMEM": "held",
  "SRC-CAND-KS-STATE-ARCHIVES": "held",
  "SRC-CAND-USGS-TOPO": "context-only",
  "SRC-CAND-KS-GIS": "candidate",
  "SRC-CAND-KS-DASC": "candidate",
...
export const SOURCE_CANDIDATES: readonly SourceCandidate[] = Object.freeze([
  ...
  Object.freeze({"id":"SRC-CAND-KSMEM","title":"Kansas Memory digital archive · manual-only","organization":"Kansas Historical Society","domain":"Historical geography","cadence":"Manual review only; no automated pull","sourceRole":"Primary-source digital collection; item-level provenance required","dataModes":["Manual browsing","Manually selected items"],"value":"Kansas Memory photographs, documents, maps and digital-collection references for item-by-item review.","cannotProve":"Browse pages or an Archive-It crawl do not grant bulk-access or reuse permission. OCR, geotags and archive metadata do not establish a historical claim or permit disclosure of sensitive cultural locations.","nextGate":"Needs a scraping agreement before any automated collection. Review Kansas Memory-specific rights, attribution, stable identifiers, provenance and cultural sensitivity. Public bulk API availability is unverified; no automated pull is authorized.","sourceUrl":"https://www.kansashistory.gov/p/online-collections/18942","checkedAt":"2026-09-20","layerId":"historical-context","featureId":"history-route-1885"}),
  Object.freeze({"id":"SRC-CAND-KS-STATE-ARCHIVES","title":"Kansas State Archives · manual-only","organization":"Kansas Historical Society","domain":"Historical geography","cadence":"Manual review only; no automated pull","sourceRole":"Government-record archive; separate item-level provenance required","dataModes":["Manual browsing","Manually selected records"],"value":"Kansas State Archives records and collection references for separately governed, item-by-item review.","cannotProve":"Shared institutional stewardship, browse pages or an Archive-It crawl do not make State Archives and Kansas Memory one source, grant bulk-access or reuse permission, or establish a historical claim.","nextGate":"Needs a State Archives-specific scraping or data-access agreement, SourceDescriptor, stable identifier mapping, rights and sensitivity decision, fixtures, provenance chain and release review before automation. No Kansas Memory analogue is reused.","sourceUrl":"https://www.kansashistory.gov/p/online-collections/18942","checkedAt":"2026-09-20"}),
