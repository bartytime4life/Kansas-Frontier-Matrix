...
export const REPOSITORY_SNAPSHOT = Object.freeze({
  ...
  mapLibre: Object.freeze({
    ...
    // Source composition is active; this is not browser acceptance.
...
const rows: readonly FeatureRow[] = [
  ...
  ["maplibre-runtime", "MapLibre browser runtime", "Map and layers", "HOLD", "The Living Atlas composes the bounded package-owned adapter; authenticated browser acceptance and production readiness remain unproved.", "packages/maplibre", "maplibre renderer adapter hold"],
