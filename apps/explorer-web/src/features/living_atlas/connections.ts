...
export const REPOSITORY_LAYER_CONNECTIONS: readonly RepositoryLayerConnection[] =
  Object.freeze([
    ...
    connection({
      ...
      summary: "The connector lane documents distinct LAZ, EPT/COPC, DEM, and derived-terrain source roles.",
      statusReason: "No bound pipeline, active descriptor, fixture evidence, or public terrain release is established.",
      cannotProve: "Survey-grade elevation, a resolved vertical datum, slope, aspect, terrain safety, or current land condition.",
      nextGate: "Bind an exact product and preserve horizontal CRS, vertical datum, geoid model, units, nodata, resolution, lineage, and review.",
      artifacts: [
