...
export const SOURCE_DESCRIPTORS: readonly SourceDescriptor[] = Object.freeze([
  ...
  source("source:kansas-mesonet", "Kansas Mesonet", "Kansas State University", "atmosphere", "https://mesonet.k-state.edu/", "Candidate station observations; official product pages are linked in the source observatory.", "A station reading does not represent a continuous statewide field or emergency guidance.", "Written operator consent is required before automated ingestion. Then verify station metadata, quality flags, units, interval, attribution, and release."),
...
export const LAYER_RECORDS: readonly LayerRecord[] = Object.freeze([
  ...
  layer("layer:air-quality", "Air-quality state-machine points", "atmosphere", "POINT", "time:present", "#d49b70", "Synthetic finite states; not monitor data, AQI, concentration, or health advice.", { sourceId: "source:site-local-atlas" }),
