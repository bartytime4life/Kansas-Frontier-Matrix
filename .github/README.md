...
|-------|----------|-------------|
| FAIR | STAC/DCAT validation | `stac-validate.yml` |
| CARE | Consent, cultural sensitivity, sovereignty | `faircare-validate.yml` |
| MCP-DL | Docs-as-Code, telemetry alignment | `docs-lint.yml`, `telemetry-export.yml` |
| SLSA / SPDX | Supply-chain + build provenance | `sbom.spdx.json`, `manifest.zip` |
| ISO Sustainability | Energy/CO₂ telemetry | `telemetry-export.yml` |
