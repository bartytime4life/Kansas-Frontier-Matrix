...
doc_uuid: "urn:kfm:doc:github:readme:v1.0.3-draft"
semantic_document_id: "kfm-github-readme-v1.0.3-draft"
event_source_id: "ledger:kfm:doc:github:readme:v1.0.3-draft"
...
6. **Data outputs are not code**  
   Derived datasets belong under `data/<domain>/processed/` and catalog outputs under `data/stac/`, `data/catalog/dcat/`, `data/prov/` — not under `src/` or `tools/`.
...
- Any change that relaxes validation, increases permissions, alters publication behavior, or touches security/sovereignty gates is **requires human review**.
