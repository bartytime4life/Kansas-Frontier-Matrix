...
└── governance_form.yml      # Ethical/cultural CARE review
~~~~~

Each form activates workflows such as:  
...
> **Important:** YAML Issue Forms must avoid reserved values (e.g., `None`). Use `"N/A"`.
...
Reviewed by **Architecture Committee** with decisions appended to the governance ledger.
...
## 🧮 Workflow Routing (Corrected Flowchart)
...
Each template includes mandatory confirmations:

- [x] Reviewed **MCP-DL v6.3**  
- [x] Included license + provenance + checksum  
