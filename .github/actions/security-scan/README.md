...
doc_uuid: "urn:kfm:doc:github-actions:security-scan:v11.2.3"
...
└── 🧱 actions/                               # Reusable composite actions
    └── 🔍 security-scan/                     # Consolidated security scan action
        ...
        ├── ⚙️ config/                        # Optional local security policy config
        ...
        └── 🧪 scripts/                       # Helper scripts (optional, language-agnostic)
            ...
            ├── 🕵️ run_secret_scans.py       # Orchestrates secret scanners
...
### From `security_audit.yml` (current pattern)
...
2. Documented here under **Behavior**.  
...
🔍 **Kansas Frontier Matrix — Security Scan Composite Action (v11.2.3)**  
