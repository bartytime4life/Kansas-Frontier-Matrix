...
according to **KFM‑MDP v11.2.6**, ensuring docs are **schema‑aligned**, **accessible**, and **provenance‑safe**  
before they enter the KFM knowledge graph and catalogs.

[![KFM-MDP v11.2.6](https://img.shields.io/badge/Markdown-KFM--MDP_v11.2.6-blue)](../../../docs/standards/kfm_markdown_protocol_v11.2.6.md)
...
- Ensures **front‑matter** conforms to **KFM‑MDP v11.2.6** and its JSON Schema.
...
- Governing spec: `docs/standards/kfm_markdown_protocol_v11.2.6.md`
...
~~~yaml
- name: ✅ Lint Markdown & front-matter (KFM-MDP v11.2.6)
...
### 1. Front‑matter Rules (KFM‑MDP v11.2.6)
...
- `markdown_protocol_version` MUST equal the governed Markdown protocol for this repo version.
...
- No references to obsolete protocol versions unless explicitly documented as historical.
- No speculative or unverified claims about governance states; such content SHOULD be flagged.
...
2. **No implicit secrets or external I/O**
   ...
   - External network calls SHOULD be avoided; if used, they MUST be documented and opt‑in.
...
3. **FAIR+CARE alignment**
   ...
   - Accessibility checks support Responsible and Collective Benefit principles.
...
5. **CI enforcement**
   ...
   - Any temporary bypass MUST be scoped, time‑boxed, recorded, and approved under emergency procedures.
...
|--------:|------------|---------|
| v11.2.2 | 2025-12-13 | Updated documentation to align with KFM‑MDP v11.2.6; normalized all inner fences to `~~~` and refreshed examples/links while preserving the v11.2.2 action contract. |
...
[⬅ Composite Actions Library](../README.md) ·
