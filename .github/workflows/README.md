...
| `verification-baseline.yml` | checked-in baseline workflow that verifies root README casing, CODEOWNERS presence, core documentation surfaces, and uploads a baseline inventory artifact | **CONFIRMED** |
