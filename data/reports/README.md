...
title: data/reports/ — Report Candidate Compatibility Lane
...
owners: NEEDS VERIFICATION — data, report, evidence, policy, rights/sensitivity, and release stewards
updated: 2026-07-24
...
current_path: data/reports/README.md
...
evidence_snapshot:
  ...
  prior_blob: e599d146def7b854a19272ad83693049f26b5882
...
# `data/reports/` — Report Candidate Compatibility Lane

> **One-line purpose.** Own only unreleased report-candidate or report-support material while routing released report payloads to `data/published/reports/` and steward-facing generated narrative to `docs/reports/`.
...
Own only unreleased report-candidate or report-support material while routing released report payloads to `data/published/reports/` and steward-facing generated narrative to `docs/reports/`.
...
**Compatibility — transitional; REPORT CANDIDATES responsibility.**
...
| Path | `data/reports/` |
| Version | `v0.2.0` |
| Prior blob | `e599d146def7b854a19272ad83693049f26b5882` |
...
- unreleased report candidates, preview/support indexes, assembly sidecars, and disposition notes;
- compatibility pointers and migration/cutover records for report candidates;
...
|---|---|
| released public report payloads | `data/published/reports/` |
| steward-facing generated narrative and review reports | `docs/reports/` |
| EvidenceBundles, proofs, receipts, catalog records, or release decisions | their owning roots |
| direct public API/UI/report serving | governed release-resolved delivery only |
...
Governed processed/catalog/proof-supported inputs and report-builder outputs that remain explicitly unreleased.
...
Report candidates for review, rejection, correction, migration, or release assembly. This path has no public-client role.
...
```text
data/reports/             = unreleased compatibility/candidate support
data/published/reports/   = release-approved public report payloads
docs/reports/             = steward-facing generated narrative and review reports
```

Readable prose, a successful render, or a map screenshot does not establish claim support or publication.
