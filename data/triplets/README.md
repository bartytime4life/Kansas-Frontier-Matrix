...
title: data/triplets/ — Relationship and Graph Projections
...
current_path: data/triplets/README.md
...
evidence_snapshot:
  ...
  prior_blob: 222277e0ba00174ca88a3c1631a27f1ba7f86294
...
# `data/triplets/` — Relationship and Graph Projections

> **One-line purpose.** Own graph-compatible triples, graph deltas, and relationship exports derived from governed records at the CATALOG/TRIPLET stage.
...
Own graph-compatible triples, graph deltas, and relationship exports derived from governed records at the CATALOG/TRIPLET stage.
...
**Canonical; TRIPLET responsibility.**
...
| Path | `data/triplets/` |
| Version | `v0.2.0` |
| Prior blob | `222277e0ba00174ca88a3c1631a27f1ba7f86294` |
...
- evidence-linked graph-compatible relationship projections;
- graph deltas, relationship exports, projection indexes, digests, and release-linked subsets;
- derived cross-domain relation packets that preserve source role and sensitivity limits;
...
Processed/cataloged objects with stable identity, evidence/source lineage, relationship semantics, and policy-safe projection rules.
...
Derived relationship projections for review and, when released, governed graph/search/API consumers. A graph edge is not sovereign truth.
...
Every claim-bearing relationship must retain resolvable evidence and source-role context. Sensitive joins—living persons, DNA/genomics, archaeology, rare species, infrastructure, property, cultural knowledge, or exact protected locations—fail closed before projection or release.

## Current bounded child-lane index

| Child lane | Bounded posture |
|---|---|
| `graph_deltas/` | Carried forward from prior parent evidence; payloads and enforcement unverified. |
| `exports/` | Carried forward from prior parent evidence; payloads and enforcement unverified. |
