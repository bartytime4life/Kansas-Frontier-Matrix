...
Includes census, administrative, economic, treaty, and archival tabular data ingested directly from verified open sources and public repositories with **FAIR+CARE** pre-audits and telemetry v2 bindings.
...
- Provide canonical inputs for **AI + Focus Mode v2** correlation workflows.
...
```json
{
  ...
  "retrieved_on": "2025-11-09T20:22:00Z",
...
```text
Kansas Frontier Matrix (2025). Raw Tabular Data (v10.0.0).
...
|---|---|---|---|
| v10.0.0 | 2025-11-09 | `@kfm-tabular` | Upgraded to v10: Streaming STAC hooks (where applicable), telemetry v2 bindings, expanded pre-audit fields. |
| v9.7.0  | 2025-11-06 | `@kfm-tabular` | Telemetry/schema refs aligned; badges hardened; clarified DCAT governance flow. |
