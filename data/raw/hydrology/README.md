...
|---|---|---:|---|---|---:|
| USGS Streamflow (daily) | USGS NWIS | 1,238,450 | CSV | Public Domain | ✅ |
| USGS Streamflow (RT) | USGS NWIS (instantaneous values) | millions | JSON | Public Domain | ✅ |
| KDHE Groundwater | Kansas Dept. of Health & Environment | 81,249 | CSV | Public Domain | ✅ |
| EPA Watershed Boundaries | EPA WBD / USGS | 3,452 | GeoJSON | Public Domain | ✅ |
| Kansas Aquifers | Kansas DASC | 1,204 | GeoJSON | Public Domain | ✅ |
| Precipitation Basins | USGS | 820 | JSON | Public Domain | ✅ |
...
|---|---|---|
| **Findable** | STAC/DCAT index + governance linkage for each dataset. | `@kfm-data` |
| **Accessible** | Public domain access; open retrieval notes documented. | `@kfm-accessibility` |
| **Interoperable** | Native formats (CSV/GeoJSON/JSON) retained; CRS honored. | `@kfm-architecture` |
| **Reusable** | Complete source, schema, license, and checksum records. | `@kfm-design` |
| **Collective Benefit** | Supports sustainable water management & education. | `@faircare-council` |
| **Authority to Control** | Council validates licensing & ingestion ethics. | `@kfm-governance` |
...
|---|---|---|
| Raw Hydrology Data | Permanent | Immutable archival for reproducibility & lineage |
...
```text
Kansas Frontier Matrix (2025). Raw Hydrology Data (v10.2.2).
Unaltered hydrological datasets sourced from USGS, EPA, KDHE, and DASC for FAIR+CARE-aligned environmental research.
Includes watershed, streamflow, realtime NWIS, and aquifer datasets preserved with checksum and governance traceability.
```
...
|---|---|---|---|
| v10.2.2 | 2025-11-12 | `@kfm-hydro` | Align to v10.2: Streaming STAC hooks (NWIS), telemetry v2 bindings, expanded pre-audit fields. |
| v10.0.0 | 2025-11-09 | `@kfm-hydro` | Streaming STAC baseline, telemetry schema refs, lifecycle policy clarified. |
| v9.7.0 | 2025-11-06 | `@kfm-hydro` | Checksum & governance audits; added sustainability metrics. |
