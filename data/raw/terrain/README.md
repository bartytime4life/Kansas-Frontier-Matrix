...
|---|---|---:|---|---|---:|
| USGS 3DEP DEM | USGS | 10 m | GeoTIFF | Public Domain | ✅ |
| NASA SRTM DEM | NASA/JPL | 30 m | GeoTIFF | Public Domain | ✅ |
| KS Contours | Kansas DASC | 10 ft | GeoJSON | Public Domain | ✅ |
| Slope Raster | Derived (USGS DEM) | 10 m | GeoTIFF | Derived (USGS) | ✅ |
| Terrain Units | Kansas Geological Survey | — | GeoJSON | Public Domain | ✅ |
