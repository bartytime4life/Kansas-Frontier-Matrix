...
title: data/proofs/ — Evidence and Proof Support
...
owners: NEEDS VERIFICATION — proof, evidence, validation, policy, and release stewards
updated: 2026-07-24
...
current_path: data/proofs/README.md
...
evidence_snapshot:
  ...
  prior_blob: 603dd71c5e0a4bd82e0228848514fd62d39b23c0
...
> **One-line purpose.** Own evidence, validation, citation, review, integrity, agreement, and release-support artifacts used to evaluate whether claims and derived products have sufficient governed support.
...
Own evidence, validation, citation, review, integrity, agreement, and release-support artifacts used to evaluate whether claims and derived products have sufficient governed support.
...
**Canonical; PROOFS responsibility.**
...
| Path | `data/proofs/` |
| Version | `v0.2.0` |
| Prior blob | `603dd71c5e0a4bd82e0228848514fd62d39b23c0` |
...
- EvidenceBundle and proof-pack instances under accepted profiles;
- validation and citation-validation reports, review support, agreement/integrity summaries, and domain proof packets;
- proof indexes and limitations that retain source, policy, review, correction, and rollback references;
...
| source/domain payloads and catalog records | their lifecycle lanes |
| release approval, promotion decisions, corrections, withdrawals, or rollback cards | `release/` |
| claims presented as public truth merely because proof files exist | release and evidence resolution still required |
...
EvidenceRefs, admitted source records, processed/catalog/triplet outputs, validation/citation reports, receipts, policy decisions, and review context.
...
Proof support for review, release, Evidence Drawer, governed API, correction, and rollback. Proof support is not release authority.
...
A proof packet must state the claim or artifact scope it supports, source roles, evidence limitations, validation profile, policy/review references, integrity, stale state, correction lineage, and release dependency. Missing support yields hold, abstain, restrict, deny, or error—not plausible completion.

## Current bounded child-lane index

| Child lane | Bounded posture |
|---|---|
| `evidence_bundle/` | Carried forward from prior parent evidence; payloads and enforcement unverified. |
| `citation_validation/` | Carried forward from prior parent evidence; payloads and enforcement unverified. |
| `proof_pack/` | Carried forward from prior parent evidence; payloads and enforcement unverified. |
| `validation_report/` | Carried forward from prior parent evidence; payloads and enforcement unverified. |
| `review/` | Carried forward from prior parent evidence; payloads and enforcement unverified. |
