<!-- [KFM_META_BLOCK_V2]
doc_id: kfm://data/receipts/release/flora/readme
name: Flora Release Receipts README
path: data/receipts/release/flora/README.md
...
artifact_family: flora-release-support-receipts
receipt_scope: flora-release-support-process-memory
domain: flora
...
sensitivity_posture: receipt-internal; no-public-path; process-memory-not-proof; release-support-not-release-authority; release-manifest-separate; review-and-policy-required; publication-separate
related:
  - ../README.md
  - ../../README.md
  - ../../flora/README.md
...
tags:
  ...
  - no-public-path
notes:
  - "This README replaces a blank placeholder at `data/receipts/release/flora/README.md`."
  ...
  - "Flora receipt docs define Flora receipts as process memory and not proof, release, sensitivity policy, catalog, or public artifact authority."
  - "Flora publication doctrine says promotion is a governed gate, not a file move or UI action."
  - "README presence confirms documentation only; it does not prove emitted release-support receipts, ReleaseManifests, validators, CI checks, signing, policy enforcement, proof closure, review closure, correction hooks, rollback hooks, or publication integration."
[/KFM_META_BLOCK_V2] -->

<a id="top"></a>

# Flora Release Receipts

Release-support receipt lane for Flora process-memory records.
...
> [!CAUTION]
> `data/receipts/release/flora/` is for Flora release-support receipt process memory only. It is not a ReleaseManifest, release decision, proof, catalog authority, policy authority, sensitivity authority, published artifact, public API/UI material, or generated-answer authority.

---

## Scope

This directory is for receipts and receipt-local sidecars that document governed Flora release-support activity: release-candidate checks, proof-reference checks, catalog-reference checks, policy-state checks, review-state checks, validation handoff, correction support, rollback support, and publication-handoff memory.

Release-support receipts record what a release-support process inspected and what finite outcome it produced. They may reference proof, catalog, policy, review, validation, correction, rollback, and publication-candidate records.

Release-support receipts do **not** approve release, create a ReleaseManifest, publish artifacts, prove Flora claims, decide sensitivity policy, define schemas, or replace ReviewRecords, PolicyDecisions, EvidenceBundles, ProofPacks, CatalogMatrix records, ReleaseManifests, CorrectionNotices, RollbackCards, or released public artifacts.
...
| Field | Value |
|---|---|
| Path | `data/receipts/release/flora/` |
...
| Review remains separate | Review state supports release review but does not become release authority. |
| Flora limits stay visible | Flora source-role, review, sensitivity, correction, and rollback boundaries must remain visible. |
...
Accepted content is limited to Flora release-support receipt instances and receipt-local sidecars:

- RunReceipt, ValidationReport, PolicyDecision reference, ReviewRecord reference, proof-closure reference, catalog-reference check, correction-support, rollback-support, and publication-handoff receipt records;
- run IDs, source refs, proof refs, catalog refs, policy refs, review refs, validation refs, release-candidate refs, publication-target refs, correction refs, rollback refs, input/output hashes, finite outcomes, reason codes, actor/runner identity, status fields, and signatures;
- receipt manifests, checksums, signing sidecars where applicable;
- README files and local indexes that help stewards inspect release-support receipt state without becoming proof, catalog, policy, release, publication, public output, Flora truth, sensitivity authority, or generated-answer authority.
...
| Released map layers, reports, or public downloads | `data/published/` |
...
This map is a proposed receipt-lane shape for documentation. It does not prove files, emitted release-support receipts, ReleaseManifests, validators, fixtures, CI checks, signing, proof closure, review closure, correction hooks, rollback hooks, or publication integration exist.
...
- [ ] Confirm the receipt belongs to the Flora domain and release-support receipt lane.
...
- [ ] Confirm proof closure and review closure resolve before any public Flora claim path uses a release-support receipt.
- [ ] Confirm receipt presence is not treated as proof, catalog closure, release approval, publication, public artifact authority, Flora truth, or sensitivity authority.
...
| Claim | Status |
|---|---|
| This README replaces a blank placeholder at `data/receipts/release/flora/README.md`. | **CONFIRMED authored** |
...
| Flora receipt docs say Flora receipts are process memory and not proof, release, sensitivity policy, catalog, or public artifact authority. | **CONFIRMED by GitHub contents API during this edit** |
| Flora publication docs say promotion is a governed state transition, not a file move or UI action, and a Flora release must pin ReleaseManifest, rollback target, and correction path. | **CONFIRMED by GitHub contents API during this edit** |
...
| Actual Flora release-support receipt payloads exist under this subtree. | **UNKNOWN** |
| Emitted release-support receipts, ReleaseManifests, validators, CI checks, signing, proof closure, review closure, correction hooks, rollback hooks, and publication integration are wired for this exact lane. | **NEEDS VERIFICATION** |
| This README is a ReleaseManifest, release decision, proof, catalog authority, policy authority, sensitivity authority, published artifact, public API/UI material, or generated-answer authority. | **DENY** |
...
KFM rule: `data/receipts/release/flora/` is a Flora release-support receipt lane for process memory only. It is not a ReleaseManifest, release decision, proof, catalog, registry, policy, sensitivity authority, publication, public artifact authority, graph authority, vector-index authority, public API/UI authority, or generated-answer truth.
