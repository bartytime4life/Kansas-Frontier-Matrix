...
- **Any cross-domain structural shifts affecting Story Nodes or Focus Mode interpretations**
...
## 📂 Directory Layout
    ...
    │
    └── 📁 stac/                                    # STAC metadata records for diffs
        ├── 📄 kansas-2024-2025-diff.json           # STAC diff representation
        └── 📄 2023-2024-diff.json                  # Prior STAC diff item
...
- Be registered under the **DCAT Dataset Catalog** for full interoperability.

All upstream datasets referenced in the diff must:

- Include updated bounding boxes  
- Publish updated `updated` timestamps  
- Provide multihash-based checksums  
- Embed USDA/USGS source metadata in provenance blocks  

---

## 🧩 Integration With KFM Pipelines

Diff reports propagate rebuild signals to:
...
## 🧪 QA, Drift Detection & Reliability
