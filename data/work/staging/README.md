...
telemetry_schema: "../../../schemas/telemetry/data-work-staging-v9.json"
...
**Purpose:**  
Serves as the **intermediate validation and schema alignment workspace** for KFM datasets between raw ingestion and final processed publication.  
All data here are under active **FAIR+CARE** governance review, schema validation, and checksum auditing before open-access certification.
...
flowchart TD
    ...
    B --> C["Schema Validation + FAIR+CARE Audits (data/work/staging/*)"]
    C --> D["Checksum Verification + Metadata Review"]
    D --> E["Promotion to Certified Processed Layer (data/work/processed/*)"]
    E --> F["Governance Ledger Registration + STAC/DCAT Sync"]
```
...
|--------|------:|-------------|
| Energy (per validation cycle) | 8.5 Wh | `@kfm-sustainability` |
...
```text
Kansas Frontier Matrix (2025). Staging Data Workspace (v9.7.0).
...
|--------:|------------|------------------|---------|
| v9.7.0  | 2025-11-06 | `@kfm-staging`   | Upgraded to v9.7.0; telemetry/schema refs aligned; lifecycle & badges updated. |
| v9.6.0  | 2025-11-03 | `@kfm-staging`   | Enhanced lifecycle automation and FAIR+CARE re-audits. |
