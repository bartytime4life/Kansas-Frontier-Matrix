...
title: data/rollback/ — Data-Plane Recovery Support
...
owners: NEEDS VERIFICATION — data, rollback, release, correction, public-surface, and domain stewards
updated: 2026-07-24
...
current_path: data/rollback/README.md
...
evidence_snapshot:
  ...
  prior_blob: e7e230b800f1ad92e798f5d5e4a33eed42841513
...
# `data/rollback/` — Data-Plane Recovery Support

> **One-line purpose.** Own data-plane alias-revert receipts, affected-artifact inventories, digest checks, invalidation references, stale-state records, and recovery support while `release/` retains rollback-decision authority.
...
Own data-plane alias-revert receipts, affected-artifact inventories, digest checks, invalidation references, stale-state records, and recovery support while `release/` retains rollback-decision authority.
...
**Canonical; ROLLBACK SUPPORT responsibility.**
...
| Path | `data/rollback/` |
| Version | `v0.2.0` |
| Prior blob | `e7e230b800f1ad92e798f5d5e4a33eed42841513` |
...
- domain/release-scoped data-plane recovery packets, alias-revert receipts, digest verification, dependency and invalidation indexes;
- rollback-local inspection notes and references to correction, withdrawal, release, cache, catalog, graph, map, API, and AI effects;
...
|---|---|
| RollbackCard, CorrectionNotice, WithdrawalNotice, release decision, or signature | `release/` |
| silent deletion, history erasure, or in-place overwrite | governed correction/rollback preserving lineage |
| ordinary source, processed, catalog, proof, receipt, or public payloads | their lifecycle/trust lanes |
...
Accountable rollback/correction decisions, prior release identity, affected-artifact graph, public-surface inventory, and tested recovery instructions.
...
Inspectible data-plane restoration and invalidation support. Rollback does not delete history or make the replacement permanently correct.
...
Accountable ownership remains **NEEDS VERIFICATION**. Changes should include data, rollback, release, correction, public-surface, and domain stewards as applicable. Payload, source activation, rights/sensitivity, migration, public-serving, correction, or rollback changes require corresponding specialist and independent review. CODEOWNERS routing is not approval evidence.
...
| Plane | Authority |
|---|---|
| release plane | decisions, cards, notices, signatures, review, correction, withdrawal |
| data plane | alias-revert receipts, affected artifacts, digest checks, dependency/public-surface invalidation |

A rollback is incomplete until released derivatives, catalogs, triplets, indexes, maps, reports, APIs, caches, and AI retrieval surfaces are rechecked.
