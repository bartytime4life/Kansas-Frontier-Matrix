...
[![FAIR+CARE Certified](https://img.shields.io/badge/FAIR%2BCARE-Q4%202025%20Archive%20Certified-gold.svg)](../../../docs/standards/faircare.md)
...
This directory aggregates the **v10.2.2 (Q4 2025)** archived datasets, their **metadata**, and **governance records**.  
...
data/archive/2025Q4/
├── README.md
├── hazards_v10.2.2/          # Certified hazards (floods, tornadoes, droughts)
├── climate_v10.2.2/          # Finalized climate (temperature, precipitation, anomalies)
├── hydrology_v10.2.2/        # Streamflow & aquifer summaries
├── landcover_v10.2.2/        # Vegetation & landcover products (e.g., NDVI, classes)
...
> All datasets have STAC Items under `data/stac/` and DCAT entries published via the STAC↔DCAT bridge; streaming updates (if any) are reflected in the Streaming STAC feed.
...
```json
{
  ...
  "timestamp": "2025-11-12T19:40:00Z"
}
```
...
```json
{
  "file": "climate_v10.2.2/noaa_precipitation_annual.csv",
...
```text
Kansas Frontier Matrix (2025). Q4 2025 Data Archive (v10.2.2).
...
| v10.0.0 | 2025-11-09 | `@kfm-archive` | Streaming STAC support, updated STAC/DCAT refs, strengthened provenance schema & sustainability policy. |
| v9.7.0 | 2025-11-06 | `@kfm-archive` | STAC/DCAT references & provenance schema updated. |
