...
> **Note:** Additional domain layers may include **lightning_density.tif**, **drought_footprint.geojson**, **debrisflow_susceptibility.tif**, etc., depending on release scope.
...
| v9.7.0  | 2025-11-06 | `@kfm-hazards`  | Paths & badges hardened; telemetry & schema refs aligned.               |
