...
│
├── hazards_composite_v10.2.2.geojson        # Multi-hazard integrated dataset (flood, tornado, drought, severe storm)
...
├── flood_risk_zones_v10.2.2.geojson         # FEMA NFHL-derived flood hazard layer (processed)
├── tornado_tracks_1950_2025_v10.2.2.geojson # Historical tornado tracks (NOAA Storm Events + SPC)
├── exposure_pop_tract_v10.2.2.parquet       # Population exposure by census tract (join fields documented)
...
> Optional domain layers per release: `lightning_density.tif`, `drought_footprint.geojson`, `debrisflow_susceptibility.tif`, etc.
...
|---|---|---|---|
| v10.2.2 | 2025-11-12 | `@kfm-hazards` | Align to v10.2: Streaming STAC support, Focus v2.1 integration, telemetry/schema v2, governance path updates. |
| v10.0.0 | 2025-11-09 | `@kfm-hazards` | Streaming STAC baseline, Focus v2 enablement, telemetry/schema v2 baseline. |
