...
| **Makefile Targets**      | `make hazards` (process all) · `make validate-hazards` (validate STAC + checksums) |
| **Containerized Runtime** | Pinned Docker image (Python + GDAL + GeoPandas)                                    |
| **QA**                    | Event counts, date ranges, and spatial bounds cross-checked vs. NOAA/FEMA/USGS     |
...
4. Validate:
   ...
   ```
5. Open a PR including: licenses/citations, script references/params, and visualization guidance.
...
| :--------- | :--------- | :------------------------------------------------------------------------------- |
| **v1.2.0** | 2025-10-11 | Added Mermaid data-flow, checksum asset in STAC, AI/Graph bindings, and QA table |
| **v1.0.1** | 2025-10-10 | Upgraded README with MCP front matter, CI targets, and QA verification details   |
