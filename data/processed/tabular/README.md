...
This layer provides validated, reproducible, and ethically governed datasets for open use, risk modeling, and **Focus Mode v2.1** hazard intelligence.
...
> Additional domain layers may include `lightning_density.tif`, `drought_footprint.geojson`, `debrisflow_susceptibility.tif`, etc., depending on release scope.
...
flowchart TD
    ...
    E --> F["STAC/DCAT Catalog Sync + Streaming STAC + Focus Mode v2.1 Enablement"]
```
...
|---|---|---|---|
| v10.2.2 | 2025-11-12 | `@kfm-hazards` | Align to v10.2: Streaming STAC support, Focus v2.1 integration, telemetry/schema v2, and governance path updates. |
| v10.0.0 | 2025-11-09 | `@kfm-hazards` | Streaming STAC support, Focus v2 enablement, telemetry/schema v2 baseline. |
