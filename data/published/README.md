...
title: data/published/ — Released Public-Safe Carriers
...
owners: NEEDS VERIFICATION — publication, release, policy, security, evidence, and domain stewards
updated: 2026-07-24
...
current_path: data/published/README.md
...
evidence_snapshot:
  ...
  prior_blob: 585abdf7953bc270a15bcf80b4dd8d6af93e70ac
...
> **One-line purpose.** Own release-approved public-safe artifact bytes and delivery sidecars consumed through governed APIs, approved static delivery, maps, exports, reports, stories, and bounded AI surfaces.
...
Own release-approved public-safe artifact bytes and delivery sidecars consumed through governed APIs, approved static delivery, maps, exports, reports, stories, and bounded AI surfaces.
...
**Canonical; PUBLISHED responsibility.**
...
| Path | `data/published/` |
| Version | `v0.2.0` |
| Prior blob | `585abdf7953bc270a15bcf80b4dd8d6af93e70ac` |
...
- release-approved layers, PMTiles, GeoParquet, API payload snapshots, reports, stories, indexes, digests, and public-safe sidecars;
- release-resolved pointers and correction/stale/supersession cues that preserve evidence and release references;
...
|---|---|
| RAW, WORK, QUARANTINE, unreleased PROCESSED, or internal catalog/triplet material | internal lifecycle lanes |
| release manifests, approval decisions, signatures, corrections, withdrawals, or rollback cards | `release/` |
| proofs, receipts, registry records, schemas, policy, or source authority | their owning roots |
| sensitive exact geometry or reconstructive metadata not approved for public exposure | restricted/quarantine handling |
...
Artifacts bound to an accountable release decision, public-safety transform, evidence/proof support, policy/review closure, correction path, and rollback target.
...
Public-safe delivery carriers through governed interfaces. Published bytes remain downstream carriers, not sovereign truth.
...
Accountable ownership remains **NEEDS VERIFICATION**. Changes should include publication, release, policy, security, evidence, and domain stewards as applicable. Payload, source activation, rights/sensitivity, migration, public-serving, correction, or rollback changes require corresponding specialist and independent review. CODEOWNERS routing is not approval evidence.
...
data/published/  = approved public-safe artifact bytes and delivery sidecars
```

Direct aliases, hosting, cache headers, invalidation, and rollback execution remain **NEEDS VERIFICATION** unless runtime and release evidence establish them.
...
| `pmtiles/` | Carried forward from prior parent evidence; payloads and enforcement unverified. |
| `reports/` | Carried forward from prior parent evidence; payloads and enforcement unverified. |
| `stories/` | Carried forward from prior parent evidence; payloads and enforcement unverified. |
