<!-- [KFM_META_BLOCK_V2]
doc_id: kfm://data/published/layers/agriculture/crop-progress-county/readme
title: data/published/layers/agriculture/crop_progress_county README
...
path: data/published/layers/agriculture/crop_progress_county/README.md
related:
  - ../../README.md
  - ../README.md
...
notes:
  - "Directory README for released county crop-progress Agriculture layer carriers. It replaces a placeholder file."
...
# `data/published/layers/agriculture/crop_progress_county/`

> Published layer sublane for released **county crop-progress Agriculture map carriers**.
...
> **Status:** `draft`  
> **Path:** `data/published/layers/agriculture/crop_progress_county/README.md`  
> **Truth posture:** CONFIRMED target path and related Agriculture layer docs from current repo evidence / PROPOSED layout and naming / NEEDS VERIFICATION for emitted county crop-progress layer files, schemas, validators, release manifests, and governed routes.
...
This lane is for released county-level Agriculture crop-progress layer carriers used by governed map, API, report, export, or UI surfaces.

Examples of valid carrier families, once released:

- county crop-progress map layers;
- county crop-progress layer sidecars;
...
- [ ] county scope, crop scope, time scope, and method are clear;
...
│   └── <release_id>/
├── indexes/
│   └── crop-progress-county-layer-index.json
└── retired/
    └── <release_id>/
```
...
```text
agriculture.published.layer.crop_progress_county.<crop>.<release_id>.<short_hash>.<ext>
```
...
County crop-progress Agriculture layers are public-facing carriers, not root truth and not release authority. Keep them citable, release-linked, correction-ready, and reversible. If release support is incomplete, keep the artifact upstream.
