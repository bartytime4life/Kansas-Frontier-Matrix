<!-- [KFM_META_BLOCK_V2]
doc_id: kfm://data/published/layers/atmosphere/climate-anomaly/readme
title: data/published/layers/atmosphere/climate_anomaly README
...
path: data/published/layers/atmosphere/climate_anomaly/README.md
related:
  - ../../README.md
  - ../README.md
...
notes:
  - "Directory README for released Atmosphere climate-anomaly layer carriers. It replaces an empty file."
  ...
  - "Climate-anomaly layer carriers must preserve baseline/reference period, method, source roles, uncertainty, caveats, correction path, and rollback support."
[/KFM_META_BLOCK_V2] -->

<a id="top"></a>

# `data/published/layers/atmosphere/climate_anomaly/`

> Published layer sublane for released **Atmosphere climate-anomaly map carriers**.
...
![Layer: climate anomaly](https://img.shields.io/badge/layer-climate--anomaly-blue)
...
> **Status:** `draft`  
> **Path:** `data/published/layers/atmosphere/climate_anomaly/README.md`  
> **Truth posture:** CONFIRMED target path, Atmosphere published README, and sibling Atmosphere layer README files from current repo evidence / PROPOSED layout and naming / NEEDS VERIFICATION for emitted climate-anomaly layer files, schemas, validators, release manifests, baseline/method records, and governed routes.

> [!WARNING]
> This directory is not release authority, climate-assessment authority, regulatory authority, raw model-field storage, catalog authority, or proof authority. A climate-anomaly layer belongs here only after release authority, EvidenceBundle support, validation, policy state, correction path, rollback support, and integrity references exist.

---

## 1. Scope

This lane is for released public-safe Atmosphere climate-anomaly layer carriers used by governed map, API, report, export, or UI surfaces.

Examples of valid carrier families, once released:

- public-safe climate-anomaly context map layers;
- climate-anomaly layer sidecars and manifests;
- public index files that point only to released climate-anomaly layers; and
- retired or superseded climate-anomaly carriers with correction or rollback references.
...
- [ ] source roles, baseline/reference period, anomaly metric, and method are clear;
...
│   └── <release_id>/
├── indexes/
│   └── atmosphere-climate-anomaly-layer-index.json
└── retired/
    └── <release_id>/
```
...
```text
atmosphere.published.layer.climate_anomaly.<scope>.<release_id>.<short_hash>.<ext>
```
...
Atmosphere climate-anomaly layers are public-facing context carriers, not root truth, release authority, official climate assessments, regulatory determinations, or raw model fields. Keep them citable, source-role-aware, baseline-aware, method-aware, uncertainty-aware, release-linked, correction-ready, and reversible. If release support is incomplete, keep the artifact upstream.
