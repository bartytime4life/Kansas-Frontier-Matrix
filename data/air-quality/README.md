...
Defines freshness gates, schema-drift detection, API lifecycle management, source-version provenance, and ingestion guardrails.
...
All content must pass KFM-MDP v11.2.2 CI enforcement.
...
All ingestion flows integrate with:

- LangGraph DAG orchestrator  
- OpenTelemetry metrics  
- OpenLineage pipeline tracking  
- Energy + carbon telemetry schemas  
- Pipeline contract enforcement (`KFM-PDC v11`)  
