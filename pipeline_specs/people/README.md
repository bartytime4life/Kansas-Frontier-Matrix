...
The local owner and CODEOWNERS review route is `@bartytime4life`. The local
scope ID is `people`; the proposed compatibility target scope is
`people-dna-land`, subject to accepted alias registration.
