...
def test_policy_attestation_and_caveats_written(tmp_path):
 run_manifest('snapshot_preservation_review_valid_manifest.json',tmp_path)
 assert (tmp_path/'snapshot_preservation_review_policy_attestation.json').exists()
 assert (tmp_path/'snapshot_preservation_review_caveat_register.json').exists()
