...
def test_status_and_report_written(tmp_path):
 run_manifest('snapshot_preservation_review_valid_manifest.json',tmp_path)
 assert (tmp_path/'snapshot_preservation_review_status_board.md').exists()
 assert (tmp_path/'snapshot_preservation_review_report.md').exists()
