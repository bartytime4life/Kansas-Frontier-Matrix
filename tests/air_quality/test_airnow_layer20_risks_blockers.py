...
def test_risks(tmp_path):
 run_one("snapshot_preservation_valid_manifest.json",tmp_path); d=json.loads((tmp_path/"snapshot_preservation_risk_register.json").read_text()); assert len(d["records"])>=3
