...
def test_inventory_written(tmp_path):
 run_one("snapshot_preservation_valid_manifest.json",tmp_path); assert (tmp_path/"snapshot_preservation_input_inventory.json").exists()
