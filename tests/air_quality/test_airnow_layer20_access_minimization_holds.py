...
def test_access_minimization_holds(tmp_path):
 run_one("snapshot_preservation_valid_manifest.json",tmp_path); assert (tmp_path/"snapshot_preservation_hold_candidate_plan.json").exists()
