...
DOMAIN_SCHEMA = (
    ROOT
    / "schemas/contracts/v1/domains/roads-rail-trade/evidence_drawer_payload.schema.json"
)
UI_SCHEMA = ROOT / "schemas/contracts/v1/ui/evidence_drawer_payload.schema.json"
DOMAIN_COMPONENT = (
    ROOT / "apps/explorer-web/src/features/domains/roads_rail_trade/EvidenceDrawer.tsx"
)


class RoadsRailTradeEvidenceDrawerConvergenceTests(unittest.TestCase):
