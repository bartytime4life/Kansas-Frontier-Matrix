#!/usr/bin/env python3
"""Regression proof for the Roads/Rail/Trade SourceDescriptor validator entrypoint.
...
VALIDATOR = REPO_ROOT / "tools/validators/domains/roads-rail-trade/validate_source_descriptor.py"
FIXTURE_ROOT = REPO_ROOT / "fixtures/domains/roads-rail-trade/source_descriptor"
VALID_FIXTURE = FIXTURE_ROOT / "valid/valid_1.json"
MISMATCH_FIXTURE = FIXTURE_ROOT / "invalid/invalid_domain_scope_mismatch.json"


class RoadsRailTradeSourceDescriptorEntrypointTests(unittest.TestCase):
    ...
    def test_out_of_scope_candidate_fails_closed(self) -> None:
        ...
        self.assertIn("'roads-rail-trade'", result.stdout)
