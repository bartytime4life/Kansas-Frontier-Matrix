...
DOMAIN_SCHEMA = ROOT / "schemas/contracts/v1/domains/roads-rail-trade/evidence_bundle.schema.json"
...
class RoadsRailTradeEvidenceBundleSchemaConvergenceTests(unittest.TestCase):
    ...
    def test_domain_projection_delegates_shape_to_shared_schema(self) -> None:
        ...
        self.assertFalse(schema["x-kfm"]["routing_authority"])
