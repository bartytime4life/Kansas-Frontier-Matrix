...
SCRIPT = ROOT / "tools/validators/domains/settlements-infrastructure/validate_schema.py"


class SettlementsInfrastructureSchemaValidatorTests(unittest.TestCase):
