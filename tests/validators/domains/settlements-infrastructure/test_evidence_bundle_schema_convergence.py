...
DOMAIN_SCHEMA = ROOT / "schemas/contracts/v1/domains/settlements-infrastructure/evidence_bundle.schema.json"
...
class SettlementsInfrastructureEvidenceBundleSchemaConvergenceTests(unittest.TestCase):
    ...
    def test_domain_projection_delegates_shape_to_shared_schema(self) -> None:
        ...
        self.assertFalse(schema["x-kfm"]["critical_infrastructure_exposure_authority"])
