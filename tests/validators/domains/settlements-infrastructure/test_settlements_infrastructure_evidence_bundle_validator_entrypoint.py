...
SCRIPT = ROOT / "tools/validators/domains/settlements-infrastructure/validate_evidence_bundle.py"


class SettlementsInfrastructureEvidenceBundleEntrypointTests(unittest.TestCase):
