...
DOMAIN_SCHEMA = ROOT / "schemas/contracts/v1/domains/archaeology/evidence_bundle.schema.json"
...
class ArchaeologyEvidenceBundleSchemaConvergenceTests(unittest.TestCase):
