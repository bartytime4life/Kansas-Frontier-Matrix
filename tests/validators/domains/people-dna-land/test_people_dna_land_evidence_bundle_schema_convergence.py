...
DOMAIN_SCHEMA = ROOT / "schemas/contracts/v1/domains/people-dna-land/evidence_bundle.schema.json"
...
class PeopleDnaLandEvidenceBundleSchemaConvergenceTests(unittest.TestCase):
    ...
    def test_domain_projection_delegates_shape_to_shared_schema(self) -> None:
        ...
        self.assertFalse(schema["x-kfm"]["living_person_or_genomic_release_authority"])
