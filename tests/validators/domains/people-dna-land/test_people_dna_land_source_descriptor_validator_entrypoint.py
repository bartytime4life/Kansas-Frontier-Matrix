#!/usr/bin/env python3
"""Regression proof for the People/DNA/Land SourceDescriptor validator entrypoint.
...
VALIDATOR = REPO_ROOT / "tools/validators/domains/people-dna-land/validate_source_descriptor.py"
FIXTURE_ROOT = REPO_ROOT / "fixtures/domains/people-dna-land/source_descriptor"
...
class PeopleDnaLandSourceDescriptorEntrypointTests(unittest.TestCase):
    ...
    def test_out_of_scope_candidate_fails_closed(self) -> None:
        ...
        self.assertIn("'people-dna-land'", result.stdout)
