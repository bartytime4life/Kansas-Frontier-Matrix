...
DOMAIN_SCHEMA = (
    ROOT / "schemas/contracts/v1/domains/geology/evidence_drawer_payload.schema.json"
)
UI_SCHEMA = ROOT / "schemas/contracts/v1/ui/evidence_drawer_payload.schema.json"
DOMAIN_COMPONENT = (
    ROOT / "apps/explorer-web/src/features/domains/geology/EvidenceDrawer.tsx"
)


class GeologyEvidenceDrawerConvergenceTests(unittest.TestCase):
