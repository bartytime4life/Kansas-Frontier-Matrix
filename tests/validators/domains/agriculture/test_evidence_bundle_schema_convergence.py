...
DOMAIN_SCHEMA = ROOT / "schemas/contracts/v1/domains/agriculture/evidence_bundle.schema.json"
...
class AgricultureEvidenceBundleSchemaConvergenceTests(unittest.TestCase):
