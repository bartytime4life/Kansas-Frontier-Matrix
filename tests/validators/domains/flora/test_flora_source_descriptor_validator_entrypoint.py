#!/usr/bin/env python3
"""Regression proof for the Flora SourceDescriptor validator entrypoint.
...
VALIDATOR = REPO_ROOT / "tools/validators/domains/flora/validate_source_descriptor.py"
FIXTURE_ROOT = REPO_ROOT / "fixtures/domains/flora/source_descriptor"
VALID_FIXTURE = FIXTURE_ROOT / "valid/valid_1.json"
MISMATCH_FIXTURE = FIXTURE_ROOT / "invalid/invalid_domain_scope_mismatch.json"


class FloraSourceDescriptorEntrypointTests(unittest.TestCase):
    ...
    def test_out_of_scope_candidate_fails_closed(self) -> None:
        ...
        self.assertIn("'flora'", result.stdout)
