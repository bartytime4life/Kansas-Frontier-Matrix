...
SPEC = importlib.util.spec_from_file_location(
    "kfm_kansas_transportation_geometry_source_assessment_registry",
    MODULE_PATH,
)
...
VALIDATOR_ID = "kansas-transportation-geometry-source-assessment"
VALIDATOR_SCRIPT = (
    "tools/validators/source/"
    "validate_kansas_transportation_geometry_source_assessment.py"
)
REPRESENTATIVE_PATHS = (
    ".github/workflows/kansas-transportation-geometry-source-assessment.yml",
    "contracts/source/kansas_transportation_geometry_source_assessment.md",
    "schemas/contracts/v1/source/"
    "kansas_transportation_geometry_source_assessment.schema.json",
    "fixtures/contracts/v1/source/"
    "kansas_transportation_geometry_source_assessment/cases.json",
    "tests/source/test_kansas_transportation_geometry_source_assessment.py",
    VALIDATOR_SCRIPT,
)


class KansasTransportationGeometrySourceAssessmentRegistryTests(unittest.TestCase):
    @classmethod
