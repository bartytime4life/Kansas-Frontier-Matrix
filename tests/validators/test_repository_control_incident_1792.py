...
FIXTURE_PATH = (
    ...
    / "context_pr_1792_terminal_divergence.json"
)
...
def test_pr_1792_is_terminal_state_divergence_from_held_projection() -> None:
...
def test_pr_1792_terminal_divergence_not_suppressed_by_non_applicability() -> None:
    context = load(FIXTURE_PATH)
    context.update(
        applicable=False,
