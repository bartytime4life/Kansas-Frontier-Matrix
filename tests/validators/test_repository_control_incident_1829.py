...
FIXTURE_PATH = (
    ...
    / "context_pr_1829_terminal_divergence.json"
)
...
def test_pr_1829_is_terminal_state_divergence_from_held_projection() -> None:
...
def test_pr_1829_terminal_divergence_not_suppressed_by_non_applicability() -> None:
    context = load(FIXTURE_PATH)
    context.update(
        applicable=False,
