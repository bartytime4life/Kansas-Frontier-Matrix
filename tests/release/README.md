...
| [`test_geoparquet_2_rc_pyarrow_carriers.py`](test_geoparquet_2_rc_pyarrow_carriers.py) | 5 at the pinned snapshot; 11 in this follow-up | Synthetic PyArrow carrier generation, digest and CRS checks, malformed readable carrier and metadata denial, finite CLI error, partial outcome, and governance-claim denial |
