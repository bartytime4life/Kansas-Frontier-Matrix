...
def test_usda_plants_evidence_drawer_payload_builder(tmp_path):
    ...
    p=next((out/"ui/flora/usda_plants/evidence_drawer").glob("*.json")); o=json.loads(p.read_text()); assert o['actions']['can_publish'] is False
