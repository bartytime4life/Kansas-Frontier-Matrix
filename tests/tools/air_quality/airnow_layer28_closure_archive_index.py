...
from kfm.air_quality.airnow.closure_archive_index import run_closure_archive_index_plan
...
def main() -> int:
    ...
    a = ap.parse_args()
    try:
        r = run_closure_archive_index_plan(a.manifest, a.out_dir, a.created_at)
