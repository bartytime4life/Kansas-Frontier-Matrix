...
from kfm.air_quality.airnow.closure_archive_index_audit.run_closure_archive_index_audit import run_closure_archive_index_audit
...
def main():
 ...
 r=run_closure_archive_index_audit(a.manifest,a.out_dir,a.created_at)
