...
const communityFixtures = [
  ["place-goodland", "Goodland", -101.71, 39.35, "LOCAL"],
  ["place-hays", "Hays", -99.33, 38.88, "REGIONAL"],
  ["place-ellsworth", "Ellsworth", -98.23, 38.73, "LOCAL"],
  ["place-wichita", "Wichita", -97.34, 37.69, "METRO"],
  ["place-manhattan", "Manhattan", -96.58, 39.18, "REGIONAL"],
  ["place-topeka", "Topeka", -95.68, 39.05, "METRO"],
  ["place-kansas-city", "Kansas City", -94.63, 39.11, "METRO"],
  ["place-garden-city", "Garden City", -100.87, 37.97, "REGIONAL"],
  ["place-dodge-city", "Dodge City", -100.02, 37.75, "REGIONAL"],
  ["place-salina", "Salina", -97.61, 38.84, "REGIONAL"],
  ["place-emporia", "Emporia", -96.18, 38.4, "REGIONAL"],
  ["place-pittsburg", "Pittsburg", -94.7, 37.41, "REGIONAL"],
] as const;

const communitiesDemo: FeatureCollection<Geometry, FeatureProperties> = {
  type: "FeatureCollection",
  features: communityFixtures.map(([id, name, lng, lat, settlementClass]) => feature(id, { type: "Point", coordinates: [lng, lat] }, {
    ...baseProps,
...
const transportDemo: FeatureCollection<Geometry, FeatureProperties> = {
  ...
  features: [
    ...
    feature("transport-rail-context", { type: "LineString", coordinates: [[-101.95, 38.48], [-100.55, 38.52], [-99.33, 38.88], [-97.61, 38.84], [-96.58, 39.18], [-95.68, 39.05], [-94.72, 39.09]] }, {
      ...baseProps,
      title: "East–west rail context",
      summary: "A deliberately generalized rail-axis fixture for relationship and accessibility exploration, not operations.",
      sourceRole: "synthetic aggregate",
      spatialScope: "Statewide rail-axis concept",
      temporalScope: "Current demonstration context",
      lastUpdate: "2026-09-01",
      evidenceState: "GENERALIZED_GEOMETRY",
      citation: "kfm:evidence:synthetic:transport-rail-v1",
      generalizationNote: "Approximate axis only; no track ownership, crossings, schedules, capacity, signaling, condition, or critical-infrastructure detail.",
      uncertainty: "Geometry is invented for MapLibre styling and cross-layer exploration.",
      relatedLayers: "Communities; People & DNA context",
      displayLabel: "Rail context",
      transportMode: "RAIL",
      focusLng: -98.3,
      focusLat: 38.85,
    }),
...
const habitatDemo: FeatureCollection<Geometry, FeatureProperties> = {
  type: "FeatureCollection",
  features: [
    feature("habitat-western-core", { type: "Polygon", coordinates: [[[-102.0, 37.25], [-100.35, 37.25], [-99.95, 38.15], [-100.55, 39.25], [-102.0, 39.55], [-102.0, 37.25]]] }, {
      ...baseProps,
      title: "Western habitat core concept",
      summary: "A coarse synthetic landscape envelope used to explore habitat relationships at regional scale.",
      sourceRole: "synthetic landscape context",
      spatialScope: "Western Kansas generalized region",
      temporalScope: "Static 2026 demonstration context",
      lastUpdate: "2026-09-01",
      evidenceState: "GENERALIZED_GEOMETRY",
      citation: "kfm:evidence:synthetic:habitat-west-v1",
      habitatClass: "CORE",
      displayLabel: "Habitat core concept",
      generalizationNote: "No parcel, nesting site, den, protected occurrence, ownership, or management boundary is present.",
      uncertainty: "Synthetic regional geometry; not a habitat suitability result.",
      relatedLayers: "Fauna range context; Flora communities",
      focusLng: -100.95,
      focusLat: 38.35,
    }),
    feature("habitat-central-corridor", { type: "Polygon", coordinates: [[[-100.2, 38.15], [-98.95, 37.85], [-96.4, 38.55], [-96.75, 39.15], [-98.65, 38.85], [-100.2, 38.15]]] }, {
      ...baseProps,
      title: "Central habitat corridor concept",
      summary: "A broad connection envelope for testing overlap, inspection, and report workflows.",
      sourceRole: "synthetic landscape context",
      spatialScope: "Central Kansas generalized corridor",
      temporalScope: "Static 2026 demonstration context",
      lastUpdate: "2026-09-01",
      evidenceState: "ANSWER",
      citation: "kfm:evidence:synthetic:habitat-central-v1",
      habitatClass: "CORRIDOR",
      displayLabel: "Habitat corridor concept",
      generalizationNote: "This shape does not identify a wildlife route, conservation easement, protected property, or management recommendation.",
      uncertainty: "Synthetic regional geometry; overlap is visual context rather than evidence.",
      relatedLayers: "Water; Roads, rail & movement",
      focusLng: -98.25,
      focusLat: 38.55,
    }),
    feature("habitat-eastern-restoration", { type: "Polygon", coordinates: [[[-97.0, 37.15], [-94.75, 37.15], [-94.75, 39.55], [-95.65, 39.35], [-96.45, 38.35], [-97.0, 37.15]]] }, {
      ...baseProps,
      title: "Eastern restoration-context concept",
      summary: "A synthetic regional zone for comparing flora, fauna, water, and settlement layers.",
      sourceRole: "synthetic landscape context",
      spatialScope: "Eastern Kansas generalized region",
      temporalScope: "Static 2026 demonstration context",
      lastUpdate: "2026-09-01",
      evidenceState: "MISSING_EVIDENCE",
      citation: "No released restoration evidence attached",
      habitatClass: "RESTORATION",
      displayLabel: "Restoration context",
      generalizationNote: "No restoration project, land status, or recommended action is asserted.",
      uncertainty: "Synthetic regional geometry; missing evidence remains explicit.",
      relatedLayers: "Flora communities; Settlements & cities",
      focusLng: -95.65,
      focusLat: 38.25,
    }),
  ],
...
const faunaDemo: FeatureCollection<Geometry, FeatureProperties> = {
  type: "FeatureCollection",
  features: [
    feature("fauna-grassland-guild", { type: "Polygon", coordinates: [[[-101.85, 37.45], [-98.55, 37.45], [-98.55, 39.45], [-101.85, 39.45], [-101.85, 37.45]]] }, {
      ...baseProps,
      title: "Grassland fauna guild context",
      summary: "A multi-species, coarse regional envelope that intentionally avoids occurrence and rare-species coordinates.",
      sourceRole: "synthetic aggregate",
      spatialScope: "Western and central Kansas, deliberately coarse",
      temporalScope: "Static 2026 demonstration context",
      lastUpdate: "2026-09-01",
      evidenceState: "GENERALIZED_GEOMETRY",
      citation: "kfm:evidence:synthetic:fauna-guild-v1",
      faunaClass: "GRASSLAND",
      displayLabel: "Grassland fauna context",
      generalizationNote: "No species occurrence, population, nest, migration track, protected location, or suitability score is encoded.",
      uncertainty: "Synthetic guild envelope for interface testing only.",
      relatedLayers: "Habitat connectivity; Flora communities",
      focusLng: -100.2,
      focusLat: 38.45,
    }),
    feature("fauna-wetland-guild", { type: "Polygon", coordinates: [[[-99.1, 37.35], [-96.35, 37.35], [-95.45, 38.45], [-96.25, 39.25], [-98.65, 38.8], [-99.1, 37.35]]] }, {
      ...baseProps,
      title: "Wetland-linked fauna guild context",
      summary: "A synthetic landscape-scale envelope for viewing water and habitat relationships without animal locations.",
      sourceRole: "synthetic aggregate",
      spatialScope: "Central and eastern Kansas, deliberately coarse",
      temporalScope: "Static 2026 demonstration context",
      lastUpdate: "2026-09-01",
      evidenceState: "DENIED_BY_POLICY",
      releaseState: "RESTRICTED",
      citation: "kfm:policy:fauna-detail-denied",
      rights: "Only a synthetic guild-level envelope is available; species and occurrence detail is denied.",
      faunaClass: "WETLAND",
      displayLabel: "Wetland fauna context",
      generalizationNote: "Exact species, occurrence, protected location, and tracking detail are absent and cannot be reconstructed client-side.",
      uncertainty: "Synthetic envelope unrelated to exact protected occurrences.",
      relatedLayers: "Water; Habitat connectivity",
      focusLng: -97.2,
      focusLat: 38.3,
    }),
  ],
...
const floraDemo: FeatureCollection<Geometry, FeatureProperties> = {
  type: "FeatureCollection",
  features: [
    ["flora-shortgrass", "Shortgrass community concept", "SHORTGRASS", -102.0, -99.75, -100.9],
    ["flora-mixed-grass", "Mixed-grass community concept", "MIXED_GRASS", -99.75, -97.25, -98.5],
    ["flora-tallgrass", "Tallgrass community concept", "TALLGRASS", -97.25, -94.7, -96.0],
  ].map(([id, title, floraClass, west, east, center]) => feature(String(id), { type: "Polygon", coordinates: [[[Number(west), 37.08], [Number(east), 37.08], [Number(east), 39.92], [Number(west), 39.92], [Number(west), 37.08]]] }, {
    ...baseProps,
    title: String(title),
    summary: "A synthetic vegetation-community band for regional comparison, not a botanical occurrence or inventory.",
    sourceRole: "synthetic aggregate",
    spatialScope: "Statewide generalized vegetation band",
    temporalScope: "Static 2026 demonstration context",
    lastUpdate: "2026-09-01",
    evidenceState: "GENERALIZED_GEOMETRY",
    citation: `kfm:evidence:synthetic:${id}`,
    floraClass: floraClass as FeatureProperties["floraClass"],
    displayLabel: String(title).replace(" concept", ""),
    generalizationNote: "No plant occurrence, rare-species location, herbarium record, collection site, or property-level vegetation claim is present.",
    uncertainty: "Synthetic longitudinal band for MapLibre styling and cross-layer inspection.",
    relatedLayers: "Habitat connectivity; Fauna range context",
    focusLng: Number(center),
    focusLat: 38.5,
  })),
};

const peopleDnaDemo: FeatureCollection<Geometry, FeatureProperties> = {
  type: "FeatureCollection",
  features: [
    feature("people-dna-aggregate-only", { type: "Polygon", coordinates: [[[-101.75, 37.35], [-99.25, 37.35], [-99.25, 39.35], [-101.75, 39.35], [-101.75, 37.35]]] }, {
      ...baseProps,
      title: "Aggregate-only people context",
      summary: "A synthetic policy zone demonstrating that only coarse, non-identifying population context could be rendered.",
      sourceRole: "synthetic policy context",
      spatialScope: "Western Kansas coarse region",
      temporalScope: "Static policy demonstration",
      lastUpdate: "2026-09-01",
      evidenceState: "GENERALIZED_GEOMETRY",
      citation: "kfm:policy:people-aggregate-only",
      consentPosture: "AGGREGATE_ONLY",
      displayLabel: "Aggregate only",
      generalizationNote: "Contains no individual, household, tribal affiliation, genealogy, kinship, genotype, phenotype, ancestry inference, or DNA sequence.",
      uncertainty: "Synthetic policy geometry; it is not a demographic result.",
      relatedLayers: "Settlements & cities; Roads, rail & movement",
      focusLng: -100.5,
      focusLat: 38.35,
    }),
    feature("people-dna-consent-required", { type: "Polygon", coordinates: [[[-99.0, 37.55], [-96.75, 37.55], [-96.75, 39.55], [-99.0, 39.55], [-99.0, 37.55]]] }, {
      ...baseProps,
      title: "Consent-required people context",
      summary: "A synthetic policy envelope showing that individual or community-linked material cannot enter the public map without authority and consent.",
      sourceRole: "synthetic policy context",
      spatialScope: "Central Kansas coarse region",
      temporalScope: "Static policy demonstration",
      lastUpdate: "2026-09-01",
      evidenceState: "RESTRICTED_ACCESS",
      releaseState: "RESTRICTED",
      citation: "kfm:policy:people-consent-required",
      rights: "Individual- and community-linked material is unavailable to this client.",
      consentPosture: "CONSENT_REQUIRED",
      displayLabel: "Consent required",
      generalizationNote: "No person, family, living individual, community membership, genealogy, genotype, phenotype, ancestry inference, or DNA sequence is present.",
      uncertainty: "Synthetic policy geometry unrelated to any person or community.",
      relatedLayers: "Settlements & cities",
      focusLng: -97.85,
      focusLat: 38.55,
    }),
    feature("people-dna-denied", { type: "Polygon", coordinates: [[[-96.55, 37.25], [-94.75, 37.25], [-94.75, 39.65], [-96.55, 39.65], [-96.55, 37.25]]] }, {
      ...baseProps,
      title: "DNA detail denied by policy",
      summary: "A coarse synthetic denial surface that proves the Explorer fails closed for DNA and living-person detail.",
      sourceRole: "synthetic policy context",
      spatialScope: "Eastern Kansas coarse region",
      temporalScope: "Withheld",
      lastUpdate: "2026-09-01",
      evidenceState: "DENIED_BY_POLICY",
      releaseState: "RESTRICTED",
      citation: "kfm:policy:dna-public-denial",
      rights: "DNA, genomic, genealogy, kinship, ancestry, and living-person detail is not authorized for this map.",
      consentPosture: "DENIED",
      displayLabel: "DNA detail denied",
      generalizationNote: "The envelope is invented and cannot be used to infer identity, membership, ancestry, kinship, phenotype, genotype, or location.",
      uncertainty: "Synthetic denial geometry unrelated to real people or genomic records.",
      relatedLayers: "Public-safe planning",
      focusLng: -95.65,
      focusLat: 38.45,
    }),
  ],
...
const fireDemo: FeatureCollection<Geometry, FeatureProperties> = {
  type: "FeatureCollection",
  features: [
    feature("fire-west-2022", { type: "Polygon", coordinates: [[[-101.75, 37.55], [-100.55, 37.35], [-99.95, 38.15], [-100.65, 38.75], [-101.75, 38.45], [-101.75, 37.55]]] }, {
      ...baseProps,
      title: "Fire-context recovery fixture · 2022",
      summary: "A stale synthetic footprint for testing fire recovery context and time controls.",
      sourceRole: "synthetic hazard context",
      spatialScope: "Western Kansas generalized envelope",
      temporalScope: "Synthetic 2022 snapshot",
      lastUpdate: "2022-07-15",
      freshnessState: "STALE",
      evidenceState: "SOURCE_STALE",
      citation: "kfm:evidence:synthetic:fire-2022",
      fireClass: "RECOVERY",
      displayLabel: "Recovery context · 2022",
      year: 2022,
      generalizationNote: "Not an active fire, ignition, burn severity product, perimeter, evacuation zone, response area, forecast, or advisory.",
      uncertainty: "Shape, status, and date are invented for temporal interface testing.",
      relatedLayers: "Smoke context; Habitat connectivity",
      focusLng: -100.85,
      focusLat: 38.05,
    }),
    feature("fire-central-2024", { type: "Polygon", coordinates: [[[-99.85, 38.0], [-98.35, 37.65], [-97.35, 38.25], [-98.0, 39.0], [-99.45, 38.85], [-99.85, 38.0]]] }, {
      ...baseProps,
      title: "Fire-context training fixture · 2024",
      summary: "A corrected synthetic footprint retained to demonstrate non-current training context.",
      sourceRole: "synthetic hazard context",
      spatialScope: "Central Kansas generalized envelope",
      temporalScope: "Synthetic 2024 snapshot",
      lastUpdate: "2024-09-10",
      evidenceState: "CORRECTED",
      citation: "kfm:evidence:synthetic:fire-2024-corrected",
      correctionState: "CORRECTED_FIXTURE",
      fireClass: "TRAINING",
      displayLabel: "Training context · 2024",
      year: 2024,
      generalizationNote: "Not an active fire, ignition, burn severity product, perimeter, evacuation zone, response area, forecast, or advisory.",
      uncertainty: "Shape, status, and date are invented for correction and timeline testing.",
      relatedLayers: "Smoke context; Hazards context",
      focusLng: -98.65,
      focusLat: 38.25,
    }),
    feature("fire-east-2026", { type: "Polygon", coordinates: [[[-97.1, 37.65], [-95.8, 37.4], [-94.85, 38.05], [-95.15, 38.95], [-96.45, 39.15], [-97.1, 37.65]]] }, {
      ...baseProps,
      title: "Fire-context watch fixture · 2026",
      summary: "A synthetic watch envelope used only to test map styling, inspection, and report caveats.",
      sourceRole: "synthetic hazard context",
      spatialScope: "Eastern Kansas generalized envelope",
      temporalScope: "Synthetic 2026 snapshot",
      lastUpdate: "2026-09-01",
      evidenceState: "GENERALIZED_GEOMETRY",
      citation: "kfm:evidence:synthetic:fire-2026",
      fireClass: "WATCH",
      displayLabel: "Watch context · synthetic",
      year: 2026,
      generalizationNote: "Not an active fire, ignition, burn severity product, perimeter, evacuation zone, response area, forecast, or advisory.",
      uncertainty: "Shape, status, and date are invented for public-safe UI testing.",
      relatedLayers: "Smoke context; Settlements & cities",
      focusLng: -95.85,
      focusLat: 38.25,
    }),
  ],
...
const hazardsDemo: FeatureCollection<Geometry, FeatureProperties> = {
  type: "FeatureCollection",
  features: [
    ["hazard-drought", "Drought context concept", "DROUGHT", -101.9, 37.2, -99.45, 39.75, -100.65, 38.45],
    ["hazard-wind", "Wind context concept", "WIND", -99.2, 37.25, -96.75, 39.65, -98.0, 38.45],
    ["hazard-flood", "Flood context concept", "FLOOD", -96.5, 37.15, -94.75, 39.7, -95.65, 38.45],
  ].map(([id, title, hazardClass, west, south, east, north, focusLng, focusLat]) => feature(String(id), { type: "Polygon", coordinates: [[[Number(west), Number(south)], [Number(east), Number(south)], [Number(east), Number(north)], [Number(west), Number(north)], [Number(west), Number(south)]]] }, {
    ...baseProps,
    title: String(title),
    summary: "A synthetic regional hazard envelope for cross-layer inspection and report-boundary testing.",
    sourceRole: "synthetic multi-hazard context",
    spatialScope: "Coarse regional demonstration envelope",
    temporalScope: "Static 2026 demonstration context",
    lastUpdate: "2026-09-01",
    evidenceState: "GENERALIZED_GEOMETRY",
    citation: `kfm:evidence:synthetic:${id}`,
    hazardClass: hazardClass as FeatureProperties["hazardClass"],
    displayLabel: String(title).replace(" concept", ""),
    generalizationNote: "Not a forecast, watch, warning, emergency product, modeled probability, floodplain, evacuation zone, or life-safety decision surface.",
    uncertainty: "Synthetic geometry and classification; never use for current conditions or response decisions.",
    relatedLayers: "Fire context; Smoke context; Water",
    focusLng: Number(focusLng),
    focusLat: Number(focusLat),
  })),
};
...
const label = (id: string, sourceId: string, color: string, size = 10, filter?: FilterSpecification): RendererDefinition => ({
  id,
  interactive: false,
...
export const LAYER_REGISTRY: LayerRecord[] = [
  ...
  {
    id: "habitat-connectivity", title: "Habitat connectivity", description: "Three public-safe landscape concepts for inspecting regional cores, corridors, and restoration context.", domain: "Habitat", category: "Habitat, fauna & flora", sourceType: "GeoJSON", sourceId: "kfm-habitat", datasetName: "KFM synthetic habitat connectivity fixtures", geometryType: "Polygon", minZoom: 4, maxZoom: 12, defaultVisibility: false, defaultOpacity: 0.22,
    legend: [{ label: "Core concept", color: "#355f43", shape: "fill" }, { label: "Corridor concept", color: "#6c9d5c", shape: "fill" }, { label: "Restoration context", color: "#b6b962", shape: "fill" }], units: "regional landscape context", scaleNote: "Coarse statewide concepts only", validTimeExtent: "Static 2026 demonstration context", sourceTime: "Site build", releaseTime: "Demonstration build", freshnessState: "NOT_APPLICABLE", attribution: "KFM site-local synthetic fixture", evidenceReference: "Per-feature demonstration reference", publicStatus: "GENERALIZED", sensitivityNote: "No parcel, protected occurrence, nest, den, management boundary, or private-property detail.", releaseState: "GENERALIZED", correctionNote: "No displayed overlap proves habitat function or a recommended action.", relatedLayers: ["Fauna range context", "Flora communities", "Hydrology context"], interactions: ["hover", "select", "zoom", "evidence", "report"], filters: ["habitat class"], viewingModes: ["2D", "globe", "pitched"], bounds: [-102.0, 37.1, -94.7, 39.6], data: habitatDemo,
    renderers: [
      { id: "habitat-connectivity-fill", interactive: true, opacityProperties: ["fill-opacity"], spec: { id: "habitat-connectivity-fill", type: "fill", source: "kfm-habitat", paint: { "fill-color": ["match", ["get", "habitatClass"], "CORE", "#355f43", "CORRIDOR", "#6c9d5c", "RESTORATION", "#b6b962", "#6c9d5c"], "fill-opacity": 0.22, "fill-outline-color": "#b8d49c" } } },
      label("habitat-connectivity-label", "kfm-habitat", "#cfe8b1", 9.5),
    ],
  },
  {
    id: "fauna-range-context", title: "Fauna range context", description: "Guild-level generalized envelopes with species and occurrence detail absent or policy-denied.", domain: "Fauna", category: "Habitat, fauna & flora", sourceType: "GeoJSON", sourceId: "kfm-fauna", datasetName: "KFM synthetic fauna guild fixtures", geometryType: "Polygon", minZoom: 5, maxZoom: 11, defaultVisibility: false, defaultOpacity: 0.16,
    legend: [{ label: "Grassland guild context", color: "#c28e55", shape: "fill" }, { label: "Wetland guild context", color: "#5f9d95", shape: "fill" }], units: "multi-species regional context", scaleNote: "Deliberately coarse guild envelopes", validTimeExtent: "Static 2026 demonstration context", sourceTime: "Site build", releaseTime: "Demonstration build", freshnessState: "NOT_APPLICABLE", attribution: "KFM site-local synthetic fixture", evidenceReference: "Per-feature evidence or denial reference", publicStatus: "GENERALIZED", sensitivityNote: "No species occurrence, population, nest, migration track, protected location, or rare-species coordinates.", releaseState: "GENERALIZED", correctionNote: "Protected and unsupported fauna detail fails closed before rendering.", relatedLayers: ["Habitat connectivity", "Flora communities", "Hydrology context"], interactions: ["hover", "select", "zoom", "evidence", "policy explanation"], filters: ["guild class"], viewingModes: ["2D", "globe"], bounds: [-101.9, 37.3, -95.4, 39.5], data: faunaDemo,
    renderers: [
      { id: "fauna-range-context-fill", interactive: true, opacityProperties: ["fill-opacity"], spec: { id: "fauna-range-context-fill", type: "fill", source: "kfm-fauna", paint: { "fill-color": ["match", ["get", "faunaClass"], "GRASSLAND", "#c28e55", "WETLAND", "#5f9d95", "MIGRATION", "#9a7cb5", "#8f9270"], "fill-opacity": 0.16, "fill-outline-color": "#e0c28e" } } },
      line("fauna-range-context-outline", "kfm-fauna", "#d9b677", 1.2, 0.62, [2, 2]),
    ],
  },
  {
    id: "flora-communities", title: "Flora communities", description: "Three synthetic vegetation-community bands for broad ecological comparison without botanical occurrences.", domain: "Flora", category: "Habitat, fauna & flora", sourceType: "GeoJSON", sourceId: "kfm-flora", datasetName: "KFM synthetic flora community fixtures", geometryType: "Polygon", minZoom: 4, maxZoom: 11, defaultVisibility: false, defaultOpacity: 0.14,
    legend: [{ label: "Shortgrass concept", color: "#ad9a5f", shape: "fill" }, { label: "Mixed-grass concept", color: "#789d62", shape: "fill" }, { label: "Tallgrass concept", color: "#477b5d", shape: "fill" }], units: "regional vegetation context", scaleNote: "Three invented longitudinal bands", validTimeExtent: "Static 2026 demonstration context", sourceTime: "Site build", releaseTime: "Demonstration build", freshnessState: "NOT_APPLICABLE", attribution: "KFM site-local synthetic fixture", evidenceReference: "Per-feature demonstration reference", publicStatus: "GENERALIZED", sensitivityNote: "No plant occurrence, rare-species location, herbarium record, collection site, or property-level vegetation claim.", releaseState: "GENERALIZED", correctionNote: "Botanical detail requires admitted, sensitivity-cleared evidence and is not inferred here.", relatedLayers: ["Habitat connectivity", "Fauna range context"], interactions: ["hover", "select", "zoom", "evidence", "report"], filters: ["vegetation class"], viewingModes: ["2D", "globe"], bounds: [-102.0, 37.05, -94.7, 39.95], data: floraDemo,
    renderers: [{ id: "flora-communities-fill", interactive: true, opacityProperties: ["fill-opacity"], spec: { id: "flora-communities-fill", type: "fill", source: "kfm-flora", paint: { "fill-color": ["match", ["get", "floraClass"], "SHORTGRASS", "#ad9a5f", "MIXED_GRASS", "#789d62", "TALLGRASS", "#477b5d", "#789d62"], "fill-opacity": 0.14, "fill-outline-color": "#a8c58e" } } }],
  },
  {
  ...
  },
  {
    ...
    renderers: [
      { id: "smoke-context-fill", interactive: true, opacityProperties: ["fill-opacity"], spec: { id: "smoke-context-fill", type: "fill", source: "kfm-smoke-context", paint: { "fill-color": ["match", ["get", "smokeDensity"], "LOW", "#8ba0aa", "MODERATE", "#b29aa8", "HIGH", "#d18787", "#a99aa8"], "fill-opacity": 0.28, "fill-outline-color": "#e4c5cf" } } },
      line("smoke-context-outline", "kfm-smoke-context", "#efd5df", 1.3, 0.72, [2, 2]),
    ],
  },
  {
    id: "fire-context", title: "Fire-context timeline", description: "Three synthetic year-specific footprints for time, correction, recovery, and not-for-life-safety testing.", domain: "Fire", category: "Fire, smoke & hazards", sourceType: "GeoJSON", sourceId: "kfm-fire-context", datasetName: "KFM synthetic fire-context fixtures", geometryType: "Polygon", minZoom: 4, maxZoom: 12, defaultVisibility: false, defaultOpacity: 0.24,
    legend: [{ label: "Recovery context", color: "#8e6756", shape: "fill" }, { label: "Training context", color: "#d18457", shape: "fill" }, { label: "Watch context · synthetic", color: "#e05b43", shape: "fill" }], units: "qualitative synthetic context", scaleNote: "Generalized statewide envelopes", validTimeExtent: "Synthetic snapshots for 2022, 2024, and 2026", sourceTime: "Per-feature synthetic year", releaseTime: "Demonstration build", freshnessState: "MIXED", attribution: "KFM site-local synthetic fixture", evidenceReference: "Per-feature demonstration reference", publicStatus: "GENERALIZED", sensitivityNote: "Not active fire, ignition, perimeter, burn severity, evacuation, forecast, response, or advisory data.", releaseState: "DEMONSTRATION", correctionNote: "The 2024 fixture preserves a visible correction state; no life-safety inference is permitted.", relatedLayers: ["Smoke context", "Hazards context", "Habitat connectivity", "Settlements & cities"], interactions: ["hover", "select", "zoom", "time", "evidence", "report"], filters: ["synthetic year", "fire context class"], viewingModes: ["2D", "globe", "pitched"], bounds: [-101.8, 37.3, -94.8, 39.2], temporal: { field: "year", mode: "exact", years: [2022, 2024, 2026], label: "Synthetic fire context" }, data: fireDemo,
    renderers: [
      { id: "fire-context-fill", interactive: true, opacityProperties: ["fill-opacity"], spec: { id: "fire-context-fill", type: "fill", source: "kfm-fire-context", paint: { "fill-color": ["match", ["get", "fireClass"], "RECOVERY", "#8e6756", "TRAINING", "#d18457", "WATCH", "#e05b43", "#bb7659"], "fill-opacity": 0.24, "fill-outline-color": "#ffb080" } } },
      line("fire-context-outline", "kfm-fire-context", "#ffb080", 1.6, 0.8, [3, 2]),
      label("fire-context-label", "kfm-fire-context", "#ffd1b4", 9.5),
    ],
  },
  {
    id: "hazards-context", title: "Multi-hazard context", description: "Synthetic drought, wind, and flood envelopes for cross-layer analysis without current-condition or life-safety claims.", domain: "Hazards", category: "Fire, smoke & hazards", sourceType: "GeoJSON", sourceId: "kfm-hazards", datasetName: "KFM synthetic multi-hazard fixtures", geometryType: "Polygon", minZoom: 4, maxZoom: 11, defaultVisibility: false, defaultOpacity: 0.12,
    legend: [{ label: "Drought concept", color: "#c7a253", shape: "fill" }, { label: "Wind concept", color: "#8f86b8", shape: "fill" }, { label: "Flood concept", color: "#4d91a9", shape: "fill" }], units: "regional hazard context", scaleNote: "Three coarse overlapping envelopes", validTimeExtent: "Static 2026 demonstration context", sourceTime: "Site build", releaseTime: "Demonstration build", freshnessState: "NOT_APPLICABLE", attribution: "KFM site-local synthetic fixture", evidenceReference: "Per-feature demonstration reference", publicStatus: "GENERALIZED", sensitivityNote: "Not a watch, warning, emergency product, forecast, probability, floodplain, evacuation zone, or response surface.", releaseState: "DEMONSTRATION", correctionNote: "Life-safety and operational hazard layers remain held until authoritative governed adapters exist.", relatedLayers: ["Fire context", "Smoke context", "Hydrology context", "Settlements & cities"], interactions: ["hover", "select", "zoom", "evidence", "report"], filters: ["hazard class"], viewingModes: ["2D", "globe"], bounds: [-101.9, 37.1, -94.7, 39.75], data: hazardsDemo,
    renderers: [
      { id: "hazards-context-fill", interactive: true, opacityProperties: ["fill-opacity"], spec: { id: "hazards-context-fill", type: "fill", source: "kfm-hazards", paint: { "fill-color": ["match", ["get", "hazardClass"], "DROUGHT", "#c7a253", "WIND", "#8f86b8", "FLOOD", "#4d91a9", "#a07d73"], "fill-opacity": 0.12, "fill-outline-color": ["match", ["get", "hazardClass"], "DROUGHT", "#e3c477", "WIND", "#b7addd", "FLOOD", "#7fc6d7", "#d0aaa0"] } } },
      line("hazards-context-outline", "kfm-hazards", "#d6b58d", 1.1, 0.58, [4, 3]),
    ],
  },
  {
    id: "people-dna-context", title: "People & DNA governance", description: "Aggregate-only, consent-required, and denied policy zones with no person-level or genomic data.", domain: "People & DNA", category: "People & DNA", sourceType: "GeoJSON", sourceId: "kfm-people-dna", datasetName: "KFM synthetic people and DNA governance fixtures", geometryType: "Polygon", minZoom: 4, maxZoom: 10, defaultVisibility: false, defaultOpacity: 0.1,
    legend: [{ label: "Aggregate only", color: "#8d8bc0", shape: "fill" }, { label: "Consent required", color: "#b77aa2", shape: "fill" }, { label: "DNA detail denied", color: "#d66a78", shape: "fill" }], units: "policy posture", scaleNote: "Invented coarse regional zones", validTimeExtent: "Static policy demonstration", sourceTime: "Site build", releaseTime: "Demonstration build", freshnessState: "NOT_APPLICABLE", attribution: "KFM site-local policy fixture", evidenceReference: "Per-feature policy reference", publicStatus: "RESTRICTED", sensitivityNote: "Contains no individual, household, tribal affiliation, community membership, genealogy, kinship, genotype, phenotype, ancestry inference, DNA sequence, or living-person detail.", releaseState: "RESTRICTED", correctionNote: "Person-level and genomic material fails closed; MapLibre is never the authority for consent, identity, ancestry, or release.", relatedLayers: ["Settlements & cities", "Roads, rail & movement", "Public-safe planning"], interactions: ["hover", "select", "policy explanation", "report"], filters: ["consent posture"], viewingModes: ["2D"], bounds: [-101.8, 37.2, -94.7, 39.7], data: peopleDnaDemo,
    renderers: [
      { id: "people-dna-context-fill", interactive: true, opacityProperties: ["fill-opacity"], spec: { id: "people-dna-context-fill", type: "fill", source: "kfm-people-dna", paint: { "fill-color": ["match", ["get", "consentPosture"], "AGGREGATE_ONLY", "#8d8bc0", "CONSENT_REQUIRED", "#b77aa2", "DENIED", "#d66a78", "#9a829f"], "fill-opacity": 0.1, "fill-outline-color": "#e2b5d2" } } },
      line("people-dna-context-outline", "kfm-people-dna", "#e2b5d2", 1.4, 0.76, [2, 3]),
      label("people-dna-context-label", "kfm-people-dna", "#f0cbe1", 9),
    ],
  },
  {
    id: "communities", title: "Settlements & cities", description: "Public place-name points with stable identifiers, scale classes, clustering, and MapLibre labels.", domain: "Settlements", category: "Settlements & cities", sourceType: "GeoJSON", sourceId: "kfm-communities", datasetName: "KFM place search fixture", geometryType: "Point", minZoom: 4, maxZoom: 16, defaultVisibility: false, defaultOpacity: 0.95,
  ...
  },
  {
    ...
    legend: [{ label: "Generalized road corridor", color: "#dc9d72", shape: "line" }, { label: "Generalized rail axis", color: "#c9b9d8", shape: "line" }], units: "not navigable", scaleNote: "Statewide generalized corridors", validTimeExtent: "Current demonstration context", sourceTime: "Site build", releaseTime: "Demonstration build", freshnessState: "NOT_APPLICABLE", attribution: "KFM site-local synthetic fixture", evidenceReference: "Per-feature demonstration reference", publicStatus: "GENERALIZED", sensitivityNote: "No routing, traffic, schedule, ownership, condition, crossing, signal, or operational critical-infrastructure detail.", releaseState: "GENERALIZED", correctionNote: "Not suitable for routing, scheduling, asset inspection, or operational decisions.", relatedLayers: ["Settlements & cities", "People & DNA governance"], interactions: ["hover", "select", "zoom", "evidence", "report"], filters: ["road or rail"], viewingModes: ["2D", "globe"], bounds: [-102.0, 37.0, -94.6, 40.0], data: transportDemo,
    renderers: [
      { id: "transport-context-road", interactive: true, opacityProperties: ["line-opacity"], baseFilter: ["==", ["get", "transportMode"], "ROAD"] as FilterSpecification, spec: { id: "transport-context-road", type: "line", source: "kfm-transport", filter: ["==", ["get", "transportMode"], "ROAD"], paint: { "line-color": "#dc9d72", "line-width": ["case", ["boolean", ["feature-state", "hover"], false], 4.2, 2.2], "line-opacity": 0.78 } } },
      { id: "transport-context-rail", interactive: true, opacityProperties: ["line-opacity"], baseFilter: ["==", ["get", "transportMode"], "RAIL"] as FilterSpecification, spec: { id: "transport-context-rail", type: "line", source: "kfm-transport", filter: ["==", ["get", "transportMode"], "RAIL"], paint: { "line-color": "#c9b9d8", "line-width": ["case", ["boolean", ["feature-state", "hover"], false], 4, 2], "line-opacity": 0.82, "line-dasharray": [4, 2] } } },
    ],
  },
  {
