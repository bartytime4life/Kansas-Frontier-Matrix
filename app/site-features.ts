...
export const SITE_FEATURES = Object.freeze([
  ...
  },
  {
    ...
    sourceIds: ["usgs-earthquakes", "raspberry-shake-stations", "usgs-streamflow", "noaa-nwps-gauges", "usgs-3dhp-hydrography", "usgs-wbd-watersheds", "noaa-nwm-analysis", "noaa-nwm-short-range", "nasa-gibs-fire-points", "nasa-firms-active-fire", "noaa-hms-smoke", "nws-alerts", "nws-radar"],
  ...
  },
  {
    ...
    domain: "smoke",
    status: "ACTIVE_CONTEXT",
    surface: "NASA GIBS dated NOAA-20 detection points and separate daily imagery, NOAA HMS smoke footprints, NWS alerts, and NOAA radar",
    userOutcome: "Select thermal detections and inspect provider fields, while viewing separate image, smoke, and radar carriers with their own clocks and gap states.",
    sourceIds: ["nasa-gibs-fire-points", "nasa-firms-active-fire", "noaa-hms-smoke", "nws-alerts", "nws-radar"],
