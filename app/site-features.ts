...
export const SITE_FEATURES = Object.freeze([
  ...
  },
  {
    ...
    sourceIds: ["usgs-earthquakes", "raspberry-shake-stations", "usgs-streamflow", "noaa-nwps-gauges", "usgs-3dhp-hydrography", "usgs-wbd-watersheds", "noaa-nwm-analysis", "noaa-nwm-short-range", "nifc-fire-reports", "nasa-gibs-fire-points", "nasa-firms-active-fire", "noaa-hms-smoke", "nws-alerts", "nws-radar"],
  ...
  },
  {
    ...
    sourceIds: ["nifc-fire-reports", "nasa-gibs-fire-points", "nasa-firms-active-fire", "noaa-hms-smoke", "nws-alerts", "nws-radar"],
