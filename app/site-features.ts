...
export const SITE_FEATURES = Object.freeze([
  ...
  },
  {
    ...
    sourceIds: ["usgs-earthquakes", "raspberry-shake-stations", "usgs-streamflow", "noaa-nwps-gauges", "usgs-3dhp-hydrography", "usgs-wbd-watersheds", "noaa-nwm-analysis", "noaa-nwm-short-range", "nasa-firms-active-fire", "noaa-hms-smoke", "nws-alerts", "nws-radar"],
  ...
  },
  {
    ...
    domain: "smoke",
    status: "ACTIVE_CONTEXT",
    surface: "NASA GIBS daily NOAA-20 thermal anomalies, NOAA HMS smoke footprints, NWS alerts, and NOAA radar",
    userOutcome: "See daily thermal-anomaly image context, dated smoke footprints, and exact radar observations beside weather context, with freshness limits and gap states exposed.",
    sourceIds: ["nasa-firms-active-fire", "noaa-hms-smoke", "nws-alerts", "nws-radar"],
