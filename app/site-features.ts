...
export const SITE_FEATURES = Object.freeze([
  ...
  },
  {
    ...
    sourceIds: ["usgs-earthquakes", "raspberry-shake-stations", "usgs-streamflow", "noaa-nwps-gauges", "usgs-3dhp-hydrography", "usgs-wbd-watersheds", "noaa-nwm-analysis", "noaa-nwm-short-range", "nifc-fire-reports", "nasa-gibs-fire-points", "nasa-firms-active-fire", "noaa-goes-geocolor", "noaa-hms-smoke", "nws-alerts", "nws-radar"],
  ...
  },
  {
    ...
    domain: "smoke",
    status: "ACTIVE_CONTEXT",
    surface: "NIFC incident reports, NASA GIBS dated NOAA-20 detection points and separate daily imagery, NOAA HMS smoke footprints, NWS alerts, and NOAA radar",
    userOutcome: "Inspect an interagency incident report and compare nearby thermal detections without treating co-location as event identity, while preserving the separate clocks and gap states of image, smoke, and radar carriers.",
    sourceIds: ["nifc-fire-reports", "nasa-gibs-fire-points", "nasa-firms-active-fire", "noaa-goes-geocolor", "noaa-hms-smoke", "nws-alerts", "nws-radar"],
