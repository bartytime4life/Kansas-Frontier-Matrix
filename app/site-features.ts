...
export const SITE_FEATURES = Object.freeze([
  ...
  },
  {
    ...
    domain: "smoke",
    status: "ACTIVE_CONTEXT",
    surface: "NASA FIRMS active-fire detections, NOAA HMS smoke footprints, NWS alerts, and NOAA radar",
    userOutcome: "See bounded fire detections, dated smoke footprints, and exact radar observations beside weather context, with freshness and gap states exposed.",
