const HOSTS = new Set(["mesonet.agron.iastate.edu", "satepsanone.nesdis.noaa.gov", "gibs.earthdata.nasa.gov", "api.gbif.org", "services.arcgis.com", "tigerweb.geo.census.gov", "tiles.arcgis.com"]);
