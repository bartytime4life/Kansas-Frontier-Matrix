...
export const MAPLIBRE_REPOSITORY_STATUS = Object.freeze([
  ...
  Object.freeze({ id: "dependency", label: "Dependency compatibility", state: "SITE 6.6.0 / REPO 6.9.0", detail: "This Site runs exact maplibre-gl 6.6.0; current repository main pins 6.9.0. Promotion remains held until one exact candidate proves worker, style, interaction, performance, and rollback compatibility." }),
