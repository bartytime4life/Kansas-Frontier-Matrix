...
const FIELDS: Readonly<Record<OfficialContextId | "registry" | "basemap", readonly (readonly [string, string])[]>> = {
  ...
  "usgs-3dhp-hydrography": [], "usgs-wbd-watersheds": [], "noaa-nwm-analysis": [], "noaa-nwm-short-range": [], "nasa-firms-active-fire": [], "noaa-goes-geocolor": [], "usgs-3dep-hillshade": [], "usgs-3dep-slope": [], "nws-radar": [],
