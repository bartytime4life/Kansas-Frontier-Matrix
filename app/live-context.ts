...
export const OFFICIAL_CONTEXT_SOURCES: readonly OfficialContextSource[] = Object.freeze([
  ...
  Object.freeze({
    ...
    title: "NASA GIBS daily VIIRS NOAA-20 thermal anomalies",
    shortTitle: "Daily fire detections",
    ...
    interactiveLayerIds: Object.freeze([]),
    mapUrl: "https://gibs.earthdata.nasa.gov/wms/epsg3857/best/wms.cgi?SERVICE=WMS&REQUEST=GetMap&VERSION=1.3.0&LAYERS=VIIRS_NOAA20_Thermal_Anomalies_375m_All&STYLES=&FORMAT=image%2Fpng&TRANSPARENT=TRUE&HEIGHT=256&WIDTH=256&CRS=EPSG%3A3857&BBOX={bbox-epsg-3857}",
    endpointLabel: "gibs.earthdata.nasa.gov · daily VIIRS NOAA-20 thermal anomalies",
    sourceUrl: "https://gibs.earthdata.nasa.gov/layer-metadata/v1.0/VIIRS_NOAA20_Thermal_Anomalies_375m_All.json",
    serviceUrl: "https://gibs.earthdata.nasa.gov/wms/epsg3857/best/wms.cgi",
    cadence: "Daily provider imagery; satellite pass, publication, and tile availability may lag",
    freshness: "Provider-default daily image at tile retrieval time; the Site does not resolve the exact UTC image date",
    defaultVisibility: false,
    defaultOpacity: 0.92,
    color: "#ff7b35",
    attribution: "NASA GIBS · VIIRS NOAA-20 thermal anomalies",
    evidenceRole: "EXTERNAL_CONTEXT_ONLY",
    boundary: "This provider-rendered daily NOAA-20 carrier indicates satellite thermal anomalies. It is not a rolling 24-hour FIRMS feed. The Site does not resolve the image date or individual detection metadata. A pixel is not a mapped perimeter, incident boundary, ignition point, burn severity estimate, evacuation area, response status, or safety guidance. It remains outside KFM evidence, reports, exports, and releases.",
