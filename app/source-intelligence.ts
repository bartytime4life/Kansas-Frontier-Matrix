...
export const SOURCE_CANDIDATES: readonly SourceCandidate[] = Object.freeze([
  ...
  Object.freeze({"id":"SRC-CAND-KSMEM","title":"Kansas Memory & State Archives · manual-only","organization":"Kansas Historical Society","domain":"Historical geography","cadence":"Manual review only; no automated pull","sourceRole":"Primary-source archive; item-level provenance required","dataModes":["Manual browsing","Manually selected items"],"value":"Cultural-heritage photographs, documents, maps and archive references for item-by-item review.","cannotProve":"Browse pages or an Archive-It crawl do not grant bulk-access or reuse permission. OCR, geotags and archive metadata do not establish a historical claim or permit disclosure of sensitive cultural locations.","nextGate":"Needs a scraping agreement before any automated collection. Review item-level rights, attribution, stable identifiers, provenance and cultural sensitivity. Public bulk API availability is unverified; no automated pull is authorized.","sourceUrl":"https://www.kansashistory.gov/p/online-collections/18942","checkedAt":"2026-09-08","layerId":"historical-context","featureId":"history-route-1885"}),
