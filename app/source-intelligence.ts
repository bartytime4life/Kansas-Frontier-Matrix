...
export const SOURCE_CANDIDATES: readonly SourceCandidate[] = Object.freeze([
  ...
  Object.freeze({ id: "SRC-CAND-KS-DASC", title: "Kansas Geoportal (DASC) live ArcGIS catalog", organization: "Kansas Data Access and Support Center / University of Kansas", domain: "Cross-domain Kansas sources", cadence: "Dataset-specific; live catalog", sourceRole: "Discovery carrier; authority remains with each publisher and item", dataModes: ["ArcGIS Hub", "Feature Service", "Map Service", "Downloads"], value: "A verified live statewide discovery surface for Kansas parcels, administrative and PLSS boundaries, hydrography, imagery, elevation, geology, habitat, and other public GIS items. Existing bounded ArcGIS REST request machinery can be reused at the protocol layer.", cannotProve: "Portal presence, a public query response, or a layer title does not prove statewide completeness, legal parcel or title truth, currentness, rights clearance, safe precision, publisher authority, KFM admission, or release. Parcel-owner and infrastructure-sensitive fields remain deny-by-default.", nextGate: "Create one SourceDescriptor per selected ArcGIS item; pin item and service identities, publisher, layer schema, modified time, count/pagination behavior, rights, attribution, sensitivity, cadence, correction behavior, and offline fixtures before activation.", sourceUrl: "https://hub.kansasgis.org/", checkedAt: "2026-09-20" }),
