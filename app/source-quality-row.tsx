...
export function SourceQualityRow({ source, state, payload, error, selected, held, onToggle }: { source: OfficialContextSource; state: OfficialContextState; payload?: OfficialContextPayload; error?: string; selected: boolean; held: boolean; onToggle: (selected: boolean) => void }) {
