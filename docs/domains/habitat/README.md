...
- **Architecture.** [`docs/architecture/governed-api/README.md`](../../architecture/governed-api/README.md) · [`docs/architecture/map-shell.md`](../../architecture/map-shell.md) · [`docs/architecture/contract-schema-policy-split.md`](../../architecture/contract-schema-policy-split.md)
