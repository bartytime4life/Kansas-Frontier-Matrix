...
| Adjacent domain: atmosphere/air | `docs/domains/atmosphere_air/README.md` | **NEEDS VERIFICATION** | Weather, climate, smoke, and EO context must keep knowledge-character labels. |
