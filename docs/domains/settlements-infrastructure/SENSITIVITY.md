...
**Source:** `docs/domains/settlements-infrastructure/API_CONTRACTS.md`  
**Referenced path:** `docs/domains/settlements-infrastructure/SENSITIVITY.md`
...
- `docs/domains/settlements-infrastructure/MISSING_OR_PLANNED_FILES.md`
