...
notes:
  ...
  - Grounded in current repository evidence; contract/schema paths remain PROPOSED or NEEDS VERIFICATION where direct repo confirmation is still pending.
