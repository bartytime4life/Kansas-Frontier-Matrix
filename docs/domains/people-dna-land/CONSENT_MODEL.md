<!-- [KFM_META_BLOCK_V2]
doc_id: kfm://doc/people-dna-land/consent-model
title: Consent Model — People / Genealogy / DNA / Land Domain
type: standard
version: v0.1
status: draft
...
**Last updated:** 2026-06-06 · **Doc id:** `kfm://doc/people-dna-land/consent-model` · **Status:** `draft` · `CONTRACT_VERSION = "3.0.0"` · [Back to top](#contents)