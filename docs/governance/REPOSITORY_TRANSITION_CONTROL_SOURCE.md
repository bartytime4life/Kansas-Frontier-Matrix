...
related:
  ...
  - https://github.com/bartytime4life/Kansas-Frontier-Matrix/issues/4233
[/KFM_META_BLOCK_V2] -->
...
Issue #4233 is the proposed live comment source for exact
`KFM_REPOSITORY_TRANSITION_AUTHORIZATION_V1` records.
...
- Keep issue #4233 open while a workflow references it.
...
or retrieval failure from skipping the only substantive classification step.
...
The active workflow and this note may move to issue #4233 before historical
...
operator to post a new authorization to deleted issue #1675 is stale and must
be reconciled before the repair is treated as complete documentation closure.
