---
title: "Dust Bowl in Kansas 🌪️🌾"
story_id: "dust-bowl"
slug: "dust-bowl"
path: "docs/stories/dust-bowl/story.md"
...
authors:
  - "Kansas Frontier Matrix (KFM) Contributors"
...
geography:
  focus: "Southwest Kansas"
  # Suggested (approx) camera targets for story.json choreography:
  center_lon_lat: [-100.92, 37.04]   # Liberal, KS (approx)
  bbox_lon_lat: [-102.10, 36.95, -99.50, 38.25]  # SW Kansas focus (approx)
...
kfm:
  story_json: "docs/stories/dust-bowl/story.json"
  media_dir: "docs/stories/dust-bowl/media"
  suggested_layers:
    - "county_boundaries"
    - "precip_anomaly"
    - "drought_severity"
