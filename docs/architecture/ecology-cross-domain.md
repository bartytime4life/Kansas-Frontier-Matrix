...
| [`docs/architecture/cross-domain-invasives.md`](./cross-domain-invasives.md) | Repository-grounded v2 domain-specific seam explanation; Fauna/Flora contracts remain draft, generic join policy inactive, public path unproven | Corroborates the bounded-seam and non-collapse pattern without creating Ecology or Invasives authority |
