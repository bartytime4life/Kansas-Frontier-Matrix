...
tags: [kfm, dcat, standards, metadata, catalog, catalog-closure, release]
...
**Quick jump:** [Purpose](#purpose) · [Repo fit](#repo-fit) · [Boundary](#boundary) · [Conformance language](#conformance-language) · [Baseline profile line](#baseline-profile-line) · [Field matrix](#field-matrix) · [Relationship to STAC and PROV](#relationship-to-stac-and-prov) · [Validation and release gates](#validation-and-release-gates) · [Illustrative JSON-LD starter](#illustrative-json-ld-starter) · [Open verification backlog](#open-verification-backlog)

> [!IMPORTANT]
> In KFM, a DCAT record is a **public discovery surface**, not:
>
> - the canonical truth store
> - the policy engine
> - the review record
> - the proof pack
> - the publication act itself
>
> It must remain downstream of release, rights, sensitivity, review, and correction closure.

> [!TIP]
> This file is the **field-level standards authority** for KFM DCAT.
>
> Directory guides such as `data/catalog/dcat/README.md` should route here for profile rules rather than silently duplicating them.
...
- canonical storage
- internal truth modeling
- machine-readable schemas
- policy bundles
- API route contracts

It defines the outward profile rules those executable surfaces should satisfy.
...
| `data/catalog/dcat/README.md` | present as the DCAT lane directory guide | keep directory-boundary prose there and field-level rules here |
| `data/catalog/README.md` | present as the triplet parent lane | keep triplet-closure language aligned |
...
### Adjacent owning surfaces

| Surface | Why it matters |
| --- | --- |
| [`./KFM_STAC_PROFILE.md`](./KFM_STAC_PROFILE.md) | companion outward item/asset discovery profile |
| [`./KFM_PROV_PROFILE.md`](./KFM_PROV_PROFILE.md) | companion outward lineage profile |
| [`../../data/catalog/dcat/README.md`](../../data/catalog/dcat/README.md) | lane README for file placement, routing, and scope boundaries |
| [`../../tools/catalog/README.md`](../../tools/catalog/README.md) | helper lane for QA, cross-link, and review support |
| [`../../contracts/README.md`](../../contracts/README.md) | human-facing machine-contract boundary |
| [`../../schemas/README.md`](../../schemas/README.md) | schema-home boundary remains active and partially unresolved |
| [`../../policy/README.md`](../../policy/README.md) | rights, sensitivity, and fail-closed publication posture |
| [`../../tests/README.md`](../../tests/README.md) | fixture and proof burden surface |

> [!WARNING]
> Public `main` now proves more structure than older doctrine-only drafts assumed. It does **not** yet prove platform settings, required checks, OIDC wiring, emitted DCAT payloads, or end-to-end release gating behavior.
...
| --- | --- | --- |
| **CONFIRMED** | directly supported by KFM doctrine and/or direct public-`main` inspection | doctrinal rules and repo-surface facts |
...
| **PROPOSED** | If one dataset exposes multiple artifact classes, publish one `dcat:Distribution` per class rather than flattening them into one ambiguous object. |
...
- reconfirm whether `updated: 2026-04-14` should remain the document date at merge time
