...
signature_ref: "../../../releases/v10.2.4/signature.sig"
attestation_ref: "../../../releases/v10.2.4/slsa-attestation.json"
sbom_ref: "../../../releases/v10.2.4/sbom.spdx.json"
manifest_ref: "../../../releases/v10.2.4/manifest.zip"
telemetry_ref: "../../../releases/v10.2.4/focus-telemetry.json"
...
json_schema_ref: "../../../schemas/json/kfm-root-governance-v10.2.4.schema.json"
shape_schema_ref: "../../../schemas/shacl/kfm-root-governance-v10.2.4-shape.ttl"

story_node_refs: []

immutability_status: "version-pinned"
doc_uuid: "urn:kfm:doc:standards:governance:root-charter:v10.2.4"
semantic_document_id: "kfm-root-governance-charter-v10.2.4"
event_source_id: "ledger:kfm:doc:standards:governance:root-charter:v10.2.4"
...
These rules are enforced through `ai_transform_permissions`, `ai_transform_prohibited`, and `transform_registry` and validated in CI.
...
- Target this charter or its subsections:
  ...
  ~~~text
  "target": "kfm-root-governance-charter-v10.2.4"
  ~~~
...
| `telemetry-export.yml` | Synchronizes governance metrics to dashboards. | `releases/v10.2.4/focus-telemetry.json` |
...
| --- | --- | --- | --- |
| **v10.2.4** | 2025-12-10 | A. Barta | Aligned Root Governance Charter with **KFM-MDP v11.2.6** (front-matter path normalization, transform registry update, test profiles, and standardized footer); no change to substantive governance rules. |
...
🏛️ **Kansas Frontier Matrix — Root Governance Charter (FAIR+CARE Council)**  
Designed for Longevity · Governed for Integrity  

[📘 Docs Root](../..) · [📂 Standards Index](../README.md) · [⚖ Governance Charter](ROOT-GOVERNANCE.md)
