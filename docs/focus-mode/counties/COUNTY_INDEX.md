...
evidence_snapshot:
  ...
  base_ref: main
  authoring_base_commit: c52bd60a10f6d536a6057d89cd4d36742bdf69b7
  current_main_inventory_commit: c52bd60a10f6d536a6057d89cd4d36742bdf69b7
  target_prior_blob: 89d7259feddf77f0229fb24bfe2244ed09b659a2
  county_tree_current_main: b60e7ffd2cd7ea12b39485409cc98bca5cad0edb
  franklin_readme_blob: 15234935b89c7815de3c1238e5caa4d78985c639
  gove_readme_blob: 777ca9609713b25c4e5678014132454620c2f9d3
  graham_readme_blob: 5a6e3ec94cf59263c4b9130a6e1ae3275c0ee5fe
  grant_readme_blob: dd84b0c37076aca2bf6cae50742ecea960613e07
  gray_readme_blob: 62081830e6712f06d1bf17165d23860ed345737d
  greeley_readme_blob: cd368abfbdae0de3ba73172e9903b7e94a5836f9
  greenwood_readme_blob: fb368c934e4ff4dedbaac0848f89eed3fb49b954
...
inspection_boundary: >-
  Current-session GitHub reads covered the complete prior v1.4 index,
  current `main@c52bd60a10f6d536a6057d89cd4d36742bdf69b7`, the complete
  non-truncated direct county tree, all 105 county directories, every direct
  README and build-artifact filename and blob size, and the merged Franklin,
  Geary, Graham, Gove, Greeley, Gray, Grant, and Greenwood README work in PRs
  #3246-#3253, plus open pull-request and task-branch search. External source
  pages, source or rights review, evidence resolution, policy evaluation,
  fixtures, runtime, releases, corrections, rollback drills, deployments, and
  public endpoints were not exercised.
related:
...
notes:
  ...
  - "v1.5 reconciles the merged Franklin, Graham, Gove, Grant, Gray, Greeley, and Greenwood README modernizations, records 49 one-byte, 56 substantive, and 51 anomalous county rows, and preserves every remaining hold."
...
> [!IMPORTANT]
> **Every Kansas county has a current repository entry, but no county is proven ready.** At current-main inventory base `c52bd60a10f6d536a6057d89cd4d36742bdf69b7`, the complete non-truncated county tree contains 105 county-shaped directories and exactly one direct build artifact in each. That evidence is sufficient to stop first-time duplicate generation; it is not evidence of semantic correctness, source rights, evidence closure, policy approval, validator success, release, or publication.
...
The counts below come from non-truncated repository tree `b60e7ffd2cd7ea12b39485409cc98bca5cad0edb` at current-main inventory base `c52bd60a10f6d536a6057d89cd4d36742bdf69b7`.
...
| One-byte README-like files | **49** | All are exact `README.md` files; byte length is inventory evidence, not content-maturity proof. |
...
| Directories with tree-level anomalies | **51** | Includes one-byte README and the bounded naming/identity findings recorded below. |
...
| [Gove](./gove_county/) | `gove_county` | [`README.md`](./gove_county/README.md) | [`gove_county_focus_mode_build_plan.md`](./gove_county/gove_county_focus_mode_build_plan.md) | `TRACKED_PAIR` |
| [Graham](./graham_county/) | `graham_county` | [`README.md`](./graham_county/README.md) | [`graham_county_focus_mode_build_plan.md`](./graham_county/graham_county_focus_mode_build_plan.md) | `TRACKED_PAIR` |
| [Grant](./grant_county/) | `grant_county` | [`README.md`](./grant_county/README.md) | [`grant_county_focus_mode_build_plan.md`](./grant_county/grant_county_focus_mode_build_plan.md) | `TRACKED_PAIR` |
| [Gray](./gray_county/) | `gray_county` | [`README.md`](./gray_county/README.md) | [`gray_county_focus_mode_build_plan.md`](./gray_county/gray_county_focus_mode_build_plan.md) | `TRACKED_PAIR` |
| [Greeley](./greeley_county/) | `greeley_county` | [`README.md`](./greeley_county/README.md) | [`greeley_county_focus_mode_build.md`](./greeley_county/greeley_county_focus_mode_build.md) | `PLAN_NAME_DRIFT` |
| [Greenwood](./greenwood_county/) | `greenwood_county` | [`README.md`](./greenwood_county/README.md) | [`greenwood_county_focus_mode_build_plan.md`](./greenwood_county/greenwood_county_focus_mode_build_plan.md) | `TRACKED_PAIR` |
...
| [Harper](./harper_county/) | `harper_county` | [`README.md`](./harper_county/README.md) | [`harper_county_focus_mode_build_plan.md`](./harper_county/harper_county_focus_mode_build_plan.md) | `TRACKED_PAIR` |
...
| `COUNTY-INV-008` | 49 README files are one byte; 56 are substantive by byte length. | Directory presence does not establish lane responsibility, ownership, or usage. | Build or repair leaf READMEs only from verified county content and inherited lane rules. |
...
|---|---|---|
| Current-main inventory base pinned | **PASS** | Base `main@c52bd60a10f6d536a6057d89cd4d36742bdf69b7`; prior index blob `89d7259feddf77f0229fb24bfe2244ed09b659a2`. |
| County tree traversal complete | **PASS** | Direct county tree `b60e7ffd2cd7ea12b39485409cc98bca5cad0edb`; `truncated: false`. |
| County universe and current README recount | **PASS** | 105 unique rows; 105 exact `README.md` files; 49 one-byte and 56 substantive README files; 51 anomalous rows after preserving all remaining naming, identity, foreign-plan, and duplicate-tree findings. |
| Current county directory links | **PASS** | All 105 directory targets exist in the pinned tree. |
| README/build-artifact links | **PASS** | Every table link resolves to a blob in the pinned tree; Franklin, Graham, Gove, Grant, Gray, Greeley, and Greenwood resolve through their current substantive `README.md` files, and Geary remains a substantive `TRACKED_PAIR`. |
...
| v1.5 | 2026-08-21 | Reconciled the merged Franklin, Graham, Gove, Grant, Gray, Greeley, and Greenwood README modernizations; recorded 49 one-byte, 56 substantive, and 51 anomalous county rows; preserved the singular/plural placement HOLD and every remaining naming, identity, validator, lifecycle, source, policy, release, deployment, and publication boundary. |
