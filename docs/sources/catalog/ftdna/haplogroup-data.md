...
version: v0.1
status: draft
owners: <PLACEHOLDER — Docs steward + Source steward for ftdna>
created: 2026-05-20
updated: 2026-05-20
policy_label: public
related:
...
tags: [kfm, docs, sources, catalog, ftdna]
notes:
...
> Y-DNA and mtDNA haplogroup assignments, admissible only at a generalized deep-haplogroup level.

**Status:** PROPOSED — scaffold only · **Family:** [`ftdna`](./README.md) · **Last reviewed:** 2026-05-20
