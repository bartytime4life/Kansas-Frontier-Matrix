...
title: LANDFIRE Vegetation and Fuels
type: product-page
version: v0.1
status: draft
...
> LANDFIRE vegetation, wildland-fuels, and disturbance and condition layers, carrying a class-map version because class semantics drift.

**Status:** PROPOSED — scaffold only · **Family:** [`landfire`](./README.md) · **Last reviewed:** 2026-05-21
...
- `connectors/lf/` — connector folder (currently an empty stub).
