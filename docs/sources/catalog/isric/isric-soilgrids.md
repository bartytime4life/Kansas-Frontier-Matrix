...
> ISRIC SoilGrids — global machine-learning-modeled soil-property grids at multiple depths.

**Status:** PROPOSED — scaffold only · **Family:** [`isric`](./README.md) · **Last reviewed:** 2026-05-21
...
- `connectors/isric/` — connector folder (currently an empty stub).
