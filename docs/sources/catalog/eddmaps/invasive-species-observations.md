...
tags: [kfm, docs, sources, catalog, eddmaps]
notes:
...
> Volunteer- and aggregator-fed observation records of invasive species and pests across the US and Canada.

**Status:** PROPOSED — scaffold only · **Family:** [`eddmaps`](./README.md) · **Last reviewed:** 2026-05-20
