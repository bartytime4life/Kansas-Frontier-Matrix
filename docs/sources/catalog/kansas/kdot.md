...
> KDOT route designation, status, work-zone, and asset-roster data, including KanPlan, KanDrive, and Kansas GIS.
...
- `connectors/kdot/` — connector folder (currently an empty stub).
