...
title: KU R. L. McGregor Herbarium
type: product-page
version: v0.1
status: draft
...
# KU R. L. McGregor Herbarium

> University of Kansas R. L. McGregor Herbarium plant specimen-portal exports and Darwin Core archives.
...
- `connectors/ku_herbarium/` — connector folder (currently an empty stub).
