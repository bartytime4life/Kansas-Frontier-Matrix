...
title: Kansas Biological Survey
type: product-page
version: v0.1
status: draft
...
> The Kansas Biological Survey (University of Kansas) biodiversity and specimen source, paired with the KU McGregor Herbarium exports.
...
- `connectors/kbs/` — connector folder (currently an empty stub).
