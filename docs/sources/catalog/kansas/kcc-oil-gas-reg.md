...
title: KCC Oil and Gas Regulatory Data
type: product-page
version: v0.1
status: draft
...
tags: [kfm, docs, sources, catalog, kansas]
notes:
  - "PROPOSED product-page scaffold; description grounded in docs/domains SOURCE_REGISTRY files."
[/KFM_META_BLOCK_V2] -->

# KCC Oil and Gas Regulatory Data

> Kansas Corporation Commission oil-and-gas regulatory and filing records; not authoritative for mineral occurrences.

**Status:** PROPOSED — scaffold only · **Family:** [`kansas`](./README.md) · **Last reviewed:** 2026-05-21
...
- `connectors/kcc_oil_gas_reg/` — connector folder (currently an empty stub).
...
## Last reviewed
2026-05-21 *(Claude Code product-page scaffold session).*
