...
> The Kansas Mesonet sub-hourly station network (weather, soil moisture, and ag-weather); admission requires written consent from the network operator.
...
- `connectors/kansas-mesonet/` — connector folder (currently an empty stub).
