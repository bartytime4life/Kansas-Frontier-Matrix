...
tags: [kfm, docs, sources, catalog, local_upload]
notes:
...
> Highest-uncertainty intake lane admitting user-supplied files (drag-and-drop, file picker, CLI imports, watcher-detected staging additions) at the trust edge.

**Status:** PROPOSED — scaffold only · **Family:** [`local_upload`](./README.md) · **Last reviewed:** 2026-05-20
