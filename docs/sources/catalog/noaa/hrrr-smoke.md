...
> The NOAA HRRR-Smoke atmospheric model field, admitted as modeled output requiring a ModelRunReceipt.
...
- `connectors/hrrr_smoke/` — connector folder (currently an empty stub).
