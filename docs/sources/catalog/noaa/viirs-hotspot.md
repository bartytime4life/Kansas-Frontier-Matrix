...
> VIIRS active-fire and thermal-hotspot detections distributed via NASA FIRMS — a detection rather than a confirmed fire.
...
- `connectors/viirs_hotspot/` — connector folder (currently an empty stub).
