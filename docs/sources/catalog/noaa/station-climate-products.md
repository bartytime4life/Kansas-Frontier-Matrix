...
> Mesonet-adjacent station observations and gridded climate products (normals, anomalies, model fields).

**Status:** PROPOSED — scaffold only · **Family:** [`noaa`](./README.md) · **Last reviewed:** 2026-05-20
