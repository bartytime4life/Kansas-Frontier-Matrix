...
version: v0.1
status: draft
owners: <PLACEHOLDER — Docs steward + Source steward for noaa>
created: 2026-05-21
updated: 2026-05-21
policy_label: public
related:
...
tags: [kfm, docs, sources, catalog, noaa]
notes:
...
> GOES Advanced Baseline Imager Aerosol Optical Depth, a sub-hourly satellite retrieval (aerosol optical depth is not PM2.5).

**Status:** PROPOSED — scaffold only · **Family:** [`noaa`](./README.md) · **Last reviewed:** 2026-05-21
...
- `connectors/goes_abi_aod/` — connector folder (currently an empty stub).
