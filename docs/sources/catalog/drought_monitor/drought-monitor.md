...
> The U.S. Drought Monitor weekly drought classification, admitted with aggregate-cell semantics.

**Status:** PROPOSED — scaffold only · **Family:** [`drought_monitor`](./README.md) · **Last reviewed:** 2026-05-21
...
- `connectors/drought-monitor/` — connector folder (currently an empty stub).
