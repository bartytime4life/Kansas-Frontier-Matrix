...
title: U.S. Drought Monitor source family
type: readme
version: v0.1
status: draft
...
tags: [kfm, docs, sources, catalog, drought_monitor]
notes:
...
# `drought_monitor` source family

> Source-oriented catalog documentation for the **U.S. Drought Monitor** source family.
...
- Connector folders: `connectors/drought-monitor/` — all currently empty stubs.
