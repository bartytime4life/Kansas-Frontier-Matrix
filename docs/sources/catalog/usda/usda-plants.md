...
> USDA PLANTS Database — the national plant checklist with taxonomy and state and county distribution.
...
- `connectors/usda-plants/` — connector folder (currently an empty stub).
