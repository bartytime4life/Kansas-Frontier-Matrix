...
> USDA National Agricultural Statistics Service county, state, and year agricultural statistics, admitted as aggregate data only.

**Status:** PROPOSED — scaffold only · **Family:** [`usda`](./README.md) · **Last reviewed:** 2026-05-21
...
- `connectors/usda-nass/` — connector folder (currently an empty stub).
