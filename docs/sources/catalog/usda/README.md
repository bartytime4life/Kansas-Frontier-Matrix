...
> Source-oriented catalog documentation for the **USDA** source family.

**Status:** draft — PROPOSED (beyond `directory-rules.md` §7.3) · **Owners:** `<PLACEHOLDER — Docs steward + Source steward for usda>` · **Last reviewed:** 2026-05-21

---

## Overview
USDA (the U.S. Department of Agriculture) is the federal agency whose National Agricultural Statistics Service and PLANTS program provide agricultural statistics, the Cropland Data Layer, and the national plant checklist. This family folder was scaffolded on 2026-05-21 because a `connectors/` companion exists; it is **not** one of the nine `directory-rules.md` §7.3 families and awaits ADR ratification — see [`OPEN-QUESTIONS.md`](../OPEN-QUESTIONS.md) `OPEN-DSC-14`.

## Product pages
| Page | Product |
|---|---|
| [`usda-nass-quickstats.md`](./usda-nass-quickstats.md) | USDA NASS QuickStats |
| [`usda-nass-cdl.md`](./usda-nass-cdl.md) | USDA NASS Cropland Data Layer |
| [`usda-plants.md`](./usda-plants.md) | USDA PLANTS Database |
...
- Connector folders: `connectors/usda/`, `connectors/usda-nass/`, `connectors/usda-plants/` — all currently empty stubs.
