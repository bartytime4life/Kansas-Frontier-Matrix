<!-- [KFM_META_BLOCK_V2]
doc_id: kfm://doc/docs-sources-catalog-blm-glo-survey-plats
title: BLM GLO Survey Plats
type: product-page
version: v0.1
status: draft
...
tags: [kfm, docs, sources, catalog, blm]
notes:
  - "PROPOSED product-page scaffold; sibling-link presence verified in Claude Code session."
[/KFM_META_BLOCK_V2] -->

# BLM GLO Survey Plats

> Cadastral survey plats, circa 1810 to present, usable as georeferenced map context.

**Status:** PROPOSED — scaffold only · **Family:** [`blm`](./README.md) · **Last reviewed:** 2026-05-20
