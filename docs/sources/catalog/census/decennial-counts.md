...
tags: [kfm, docs, sources, catalog, census]
notes:
...
> Decennial census population and housing counts as aggregate tables by county, tract, block group, place, and block.

**Status:** PROPOSED — scaffold only · **Family:** [`census`](./README.md) · **Last reviewed:** 2026-05-20
