...
> NASA Soil Moisture Active Passive mission L-band satellite soil-moisture retrievals, admitted as a modeled and observed context layer.
...
- `connectors/nasa-smap/` — connector folder (currently an empty stub).
