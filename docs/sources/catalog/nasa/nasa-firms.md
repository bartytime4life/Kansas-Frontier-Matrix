...
> NASA Fire Information for Resource Management System — near-real-time satellite active-fire and hot-spot detections, admitted as candidate detections (a detection is not a confirmed fire).

**Status:** PROPOSED — scaffold only · **Family:** [`nasa`](./README.md) · **Last reviewed:** 2026-05-21
...
- `connectors/nasa-firms/` — connector folder (currently an empty stub).
