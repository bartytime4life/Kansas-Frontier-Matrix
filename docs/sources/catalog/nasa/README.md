...
> Source-oriented catalog documentation for the **NASA** source family.

**Status:** draft — PROPOSED (beyond `directory-rules.md` §7.3) · **Owners:** `<PLACEHOLDER — Docs steward + Source steward for nasa>` · **Last reviewed:** 2026-05-21

---

## Overview
NASA (the National Aeronautics and Space Administration) is the U.S. federal agency whose Earth-observation programs supply satellite remote-sensing products used across the hazards, atmosphere, soil, and agriculture domains. This family folder was scaffolded on 2026-05-21 because a `connectors/` companion exists; it is **not** one of the nine `directory-rules.md` §7.3 families and awaits ADR ratification — see [`OPEN-QUESTIONS.md`](../OPEN-QUESTIONS.md) `OPEN-DSC-14`.

## Product pages
| Page | Product |
|---|---|
| [`nasa-earthdata.md`](./nasa-earthdata.md) | NASA Earthdata |
| [`nasa-firms.md`](./nasa-firms.md) | NASA FIRMS Active Fire |
| [`nasa-hls.md`](./nasa-hls.md) | NASA HLS Harmonized Imagery |
| [`nasa-smap.md`](./nasa-smap.md) | NASA SMAP Soil Moisture |
...
- Connector folders: `connectors/nasa/`, `connectors/nasa-earthdata/`, `connectors/nasa-firms/`, `connectors/nasa-hls/`, `connectors/nasa-smap/` — all currently empty stubs.
