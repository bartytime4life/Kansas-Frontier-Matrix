...
> NASA's Earth-science data access platform and credentialed gateway through which the MAIAC AOD, HLS, and FIRMS products are retrieved.
...
- `connectors/nasa-earthdata/` — connector folder (currently an empty stub).
