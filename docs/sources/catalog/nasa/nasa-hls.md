...
> Harmonized Landsat and Sentinel-2 surface-reflectance imagery and vegetation indices, used as a context layer rather than field truth.
...
- `connectors/nasa-hls/` — connector folder (currently an empty stub).
