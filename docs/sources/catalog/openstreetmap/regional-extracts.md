...
tags: [kfm, docs, sources, catalog, openstreetmap]
notes:
...
> State and country-level OSM snapshot extracts used as the canonical RAW capture for bulk processing.

**Status:** PROPOSED — scaffold only · **Family:** [`openstreetmap`](./README.md) · **Last reviewed:** 2026-05-20
