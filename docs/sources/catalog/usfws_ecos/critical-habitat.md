<!-- [KFM_META_BLOCK_V2]
doc_id: kfm://doc/docs-sources-catalog-usfws_ecos-critical-habitat
title: USFWS Designated Critical Habitat
type: product-page
version: v0.1
status: draft
...
tags: [kfm, docs, sources, catalog, usfws_ecos]
notes:
...
> Final and proposed designated critical habitat geometries via ECOS ArcGIS Feature/Map/Tile services.

**Status:** PROPOSED — scaffold only · **Family:** [`usfws_ecos`](./README.md) · **Last reviewed:** 2026-05-20
