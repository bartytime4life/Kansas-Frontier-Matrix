...
tags: [kfm, docs, sources, catalog, idigbio]
notes:
...
> Bulk Darwin Core Archive downloads from the iDigBio portal with citation files.

**Status:** PROPOSED — scaffold only · **Family:** [`idigbio`](./README.md) · **Last reviewed:** 2026-05-20
