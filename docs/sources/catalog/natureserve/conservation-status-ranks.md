...
version: v0.1
status: draft
owners: <PLACEHOLDER — Docs steward + Source steward for natureserve>
created: 2026-05-20
updated: 2026-05-20
policy_label: public
related:
...
tags: [kfm, docs, sources, catalog, natureserve]
notes:
...
> Global (G-rank) and subnational (S-rank) conservation-status rankings driving KFM's sensitivity rubric.

**Status:** PROPOSED — scaffold only · **Family:** [`natureserve`](./README.md) · **Last reviewed:** 2026-05-20
