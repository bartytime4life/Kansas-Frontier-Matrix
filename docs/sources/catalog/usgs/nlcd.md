...
tags: [kfm, docs, sources, catalog, usgs]
notes:
...
> The USGS National Land Cover Database national land-cover classification raster, carrying a class-map version.

**Status:** PROPOSED — scaffold only · **Family:** [`usgs`](./README.md) · **Last reviewed:** 2026-05-21
...
- `connectors/nlcd/` — connector folder (currently an empty stub).
