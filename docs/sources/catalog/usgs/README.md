...
| **The National Map** — discovery/download platform | `usgs-tnm` | `aggregator` of program assets *(carrier; per-asset role applies)* | Spatial Foundation (cross-cutting) | PROPOSED — external surfaces refreshed 2026-09-14; admission remains unproved | **PROPOSED — [draft authored](./the-national-map.md); carrier disposition remains OPEN** |
...
| `usgs-tnm` | [`the-national-map.md`](./the-national-map.md) | **PROPOSED — draft authored; disposition UNDECIDED**. TNM is a discovery/download carrier, not a content source. The page records current official access surfaces without admitting or activating a source. |
