...
tags: [kfm, docs, sources, catalog, loc]
notes:
...
> Historic newspaper pages and OCR text used as contextual evidence for the People-Place-Event graph.

**Status:** PROPOSED — scaffold only · **Family:** [`loc`](./README.md) · **Last reviewed:** 2026-05-20
