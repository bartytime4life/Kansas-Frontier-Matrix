...
tags: [kfm, docs, sources, catalog, inaturalist]
notes:
...
> Community-rated, identifier-graded species occurrence records from the iNaturalist API.

**Status:** PROPOSED — scaffold only · **Family:** [`inaturalist`](./README.md) · **Last reviewed:** 2026-05-20
