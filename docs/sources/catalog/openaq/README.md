...
tags: [kfm, docs, sources, catalog, openaq]
notes:
...
> Source-oriented catalog documentation for the **OpenAQ** source family.

**Status:** draft — PROPOSED (beyond `directory-rules.md` §7.3) · **Owners:** `<PLACEHOLDER — Docs steward + Source steward for openaq>` · **Last reviewed:** 2026-05-21

---

## Overview
OpenAQ is an open-data platform that aggregates global air-quality measurements from government and community sensors. This family folder was scaffolded on 2026-05-21 because a `connectors/` companion exists; it is **not** one of the nine `directory-rules.md` §7.3 families and awaits ADR ratification — see [`OPEN-QUESTIONS.md`](../OPEN-QUESTIONS.md) `OPEN-DSC-14`.

## Product pages
| Page | Product |
|---|---|
| [`openaq.md`](./openaq.md) | OpenAQ Air Quality Aggregator |
...
- Connector folders: `connectors/openaq/` — all currently empty stubs.
