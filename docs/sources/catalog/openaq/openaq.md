...
> The OpenAQ open air-quality aggregator delivering government and community sensor measurements.

**Status:** PROPOSED — scaffold only · **Family:** [`openaq`](./README.md) · **Last reviewed:** 2026-05-21
...
- `connectors/openaq/` — connector folder (currently an empty stub).
