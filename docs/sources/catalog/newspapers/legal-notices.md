...
tags: [kfm, docs, sources, catalog, newspapers]
notes:
...
> Land patents, sheriff's sales, and election proclamations published as the legally required notice surface.

**Status:** PROPOSED — scaffold only · **Family:** [`newspapers`](./README.md) · **Last reviewed:** 2026-05-20
