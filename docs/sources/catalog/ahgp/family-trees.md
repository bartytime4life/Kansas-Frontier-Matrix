<!-- [KFM_META_BLOCK_V2]
doc_id: kfm://doc/docs-sources-catalog-ahgp-family-trees
title: AHGP Volunteer Family Trees
type: product-page
version: v0.1
status: draft
...
tags: [kfm, docs, sources, catalog, ahgp]
notes:
  - "PROPOSED product-page scaffold; sibling-link presence verified in Claude Code session."
[/KFM_META_BLOCK_V2] -->

# AHGP Volunteer Family Trees

> Volunteer-contributed family trees admitted only as relationship hypotheses.

**Status:** PROPOSED — scaffold only · **Family:** [`ahgp`](./README.md) · **Last reviewed:** 2026-05-20
