...
> Surface Transportation Board weekly operational metrics from the seven Class I rail carriers.
...
- `connectors/stb_class1/` — connector folder (currently an empty stub).
