...
> The FRA canonical inventory of public and private highway-rail grade crossings with per-crossing safety attributes.

**Status:** PROPOSED — scaffold only · **Family:** [`usdot`](./README.md) · **Last reviewed:** 2026-05-21
...
- `connectors/fra_gcis/` — connector folder (currently an empty stub).
