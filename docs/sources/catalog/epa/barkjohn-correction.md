...
tags: [kfm, docs, sources, catalog, epa]
notes:
...
> Published regression that reconciles PurpleAir low-cost sensors to regulatory monitors.

**Status:** PROPOSED — scaffold only · **Family:** [`epa`](./README.md) · **Last reviewed:** 2026-05-20
