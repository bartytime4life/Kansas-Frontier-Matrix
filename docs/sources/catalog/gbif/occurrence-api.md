...
tags: [kfm, docs, sources, catalog, gbif]
notes:
...
> Synchronous occurrence search delivering spatial subsets of biodiversity occurrence records.

**Status:** PROPOSED — scaffold only · **Family:** [`gbif`](./README.md) · **Last reviewed:** 2026-05-20
