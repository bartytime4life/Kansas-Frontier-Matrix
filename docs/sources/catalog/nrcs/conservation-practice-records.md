<!-- [KFM_META_BLOCK_V2]
doc_id: kfm://doc/docs-sources-catalog-nrcs-conservation-practice-records
...
tags: [kfm, docs, sources, catalog, nrcs]
notes:
...
> Agency field-implementation records of conservation practices.

**Status:** PROPOSED — scaffold only · **Family:** [`nrcs`](./README.md) · **Last reviewed:** 2026-05-20
