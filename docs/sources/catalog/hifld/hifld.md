...
tags: [kfm, docs, sources, catalog, hifld]
notes:
...
> HIFLD geospatial critical-infrastructure layers, used in KFM for rail lines, yards, and structures.

**Status:** PROPOSED — scaffold only · **Family:** [`hifld`](./README.md) · **Last reviewed:** 2026-05-21
...
- `connectors/hifld/` — connector folder (currently an empty stub).
