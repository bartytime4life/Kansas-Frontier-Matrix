...
> Source-oriented catalog documentation for the **HIFLD** source family.
...
## Overview
HIFLD (Homeland Infrastructure Foundation-Level Data) is a U.S. national geospatial program that publishes foundation-level critical-infrastructure layers. This family folder was scaffolded on 2026-05-21 because a `connectors/` companion exists; it is **not** one of the nine `directory-rules.md` §7.3 families and awaits ADR ratification — see [`OPEN-QUESTIONS.md`](../OPEN-QUESTIONS.md) `OPEN-DSC-14`.

## Product pages
| Page | Product |
|---|---|
| [`hifld.md`](./hifld.md) | HIFLD Infrastructure Layers |
...
- Connector folders: `connectors/hifld/` — all currently empty stubs.
