...
tags: [kfm, docs, sources, catalog, manual_curation]
notes:
...
> The steward-led path that walks a source from admission through review, validation, and catalog closure.

**Status:** PROPOSED — scaffold only · **Family:** [`manual_curation`](./README.md) · **Last reviewed:** 2026-05-20
