...
| `NIP-2026-09-10-living-atlas-temporal-sources` | Living Atlas deep-time-to-present research request and connected Drive/Notion design context | Research checkpoint 2026-09-10 | TRIAGED / EXPLORATORY / HOLD | Earth-history time spine, paleogeography, historical editions, modern point candidates, temporal clocks, governed API/UI delivery, and repository/source identity gaps. | Detailed routing in [`exploratory/living-atlas-deep-time-to-present-source-map-20260910.md`](exploratory/living-atlas-deep-time-to-present-source-map-20260910.md); 15th Source Observatory card records the existing earthquake documentation gap only. | Resolve connector placement and rights before source code or capture; real exports stay out of fixtures and frontend code; require lifecycle, evidence, policy, manifests, release, correction, rollback, and exact-time browser behavior before public points. |
