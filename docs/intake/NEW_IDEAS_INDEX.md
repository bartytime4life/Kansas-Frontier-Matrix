...
related: [docs/doctrine/directory-rules.md, docs/intake/README.md, docs/intake/new-ideas-register.md, docs/intake/exploratory/new-ideas-4-13-source-map.md, docs/intake/exploratory/new-ideas-4-14-source-map.md, docs/intake/exploratory/new-ideas-4-15-source-map.md, docs/intake/exploratory/new-ideas-4-16-source-map.md, docs/intake/exploratory/new-ideas-4-23-source-map.md, docs/intake/exploratory/new-ideas-4-25-source-map.md, docs/intake/exploratory/new-ideas-4-30-source-map.md, docs/intake/exploratory/new-ideas-5-source-map.md, docs/intake/exploratory/new-ideas-5-19-26-source-map.md, docs/intake/exploratory/spatiotemporal-modernization-blueprint-source-map.md, docs/intake/exploratory/tile-artifact-manifest-pmtiles-profile-source-map.md, docs/intake/exploratory/living-atlas-deep-time-to-present-source-map-20260910.md, docs/registers/DRIFT_REGISTER.md, docs/registers/VERIFICATION_BACKLOG.md]
...
| `NIP-2026-09-10-living-atlas-temporal-sources` | Living Atlas deep-time-to-present research request and connected Drive/Notion design context | Research checkpoint 2026-09-10 | TRIAGED / EXPLORATORY / HOLD | Earth-history time spine, paleogeography, historical editions, modern point candidates, temporal clocks, governed API/UI delivery, and repository/source identity gaps. | Detailed routing in [`exploratory/living-atlas-deep-time-to-present-source-map-20260910.md`](exploratory/living-atlas-deep-time-to-present-source-map-20260910.md); 15th Source Observatory card records the existing earthquake documentation gap only. | Preserve accepted connector/lifecycle roots; resolve canonical earthquake source identity, standalone-versus-USGS-family placement, ownership, rights, and admission before source code or capture. Real exports stay out of fixtures and frontend code; require lifecycle, evidence, policy, manifests, release, correction, rollback, and exact-time browser behavior before public points. |
