...
| Focused EvidenceBundle packet | **CONFIRMED bounded executable proof** | The [validator](../../../tools/validators/validate_settlements_infrastructure_evidence_bundle_projection.py), [test](../../../tests/validators/domains/settlements-infrastructure/test_settlements_infrastructure_evidence_bundle_schema_convergence.py), and read-only no-network [workflow](../../../.github/workflows/settlements-infrastructure-evidence-bundle-convergence.yml) validate delegation and fixture polarity. | Live EvidenceRef resolution, claim truth, sensitivity review, policy enforcement, release, or dashboard telemetry. |
| Domain-local validator/test lanes | **PARTIAL / HOLD** | [`validate_schema.py`](../../../tools/validators/domains/settlements-infrastructure/validate_schema.py) now checks that every Settlements/Infrastructure JSON Schema document is a structurally valid Draft 2020-12 schema (see [`test_settlements_infrastructure_schema_validator.py`](../../../tests/validators/domains/settlements-infrastructure/test_settlements_infrastructure_schema_validator.py)); [`test_restricted_geometry_no_leak.py`](../../../tests/domains/settlements-infrastructure/test_restricted_geometry_no_leak.py) is still docstring-only. | Substantive semantic, geometry, public-boundary, or sensitivity validation. |
