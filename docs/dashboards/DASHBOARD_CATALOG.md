...
notes:
  ...
  - "This v0.7 refresh preserves the merged People/DNA/Land and Roads / Rail / Trade reconciliations and adds the Settlements / Infrastructure row reconciliation against current domain, EvidenceBundle projection, Explorer placeholder, policy/validator/test scaffold, source-registry, proof, and release-hold evidence without claiming a routed dashboard or production telemetry."
...
| 33 dashboard spec files are cataloged below. | CONFIRMED at the pinned repository tree. | Direct current-tree listings at `main@8b9e457c1e59ef7a0813ef6407fee33f22d2a841` contain 5 governance, 4 operational, 13 domain, and 11 observability spec files, excluding category READMEs. |
