...
notes:
  ...
  - "This v0.6 refresh reconciles the Settlements / Infrastructure row with current bounded evidence-projection, policy/readiness, Explorer-placeholder, and proof/release-hold evidence without claiming a routed dashboard or production telemetry."
  - "This v0.7 refresh restores the Roads / Rail / Trade row after concurrent dashboard merges while preserving the People/DNA/Land and Settlements / Infrastructure reconciliations; no runtime, source, policy, release, deployment, or publication state is asserted."
...
| 33 dashboard spec files are cataloged below. | CONFIRMED at the pinned repository tree. | Direct current-tree listings at `main@a490defd12608f4159544e717e38e7a8224d9cfe` contain 5 governance, 4 operational, 13 domain, and 11 observability spec files, excluding category READMEs. |
