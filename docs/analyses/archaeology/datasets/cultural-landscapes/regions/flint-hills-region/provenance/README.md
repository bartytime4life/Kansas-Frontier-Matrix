---
title: "🧬 KFM v11.2.3 — Flint Hills Eco-Cultural Region Provenance Refs (Diamond⁹ Ω / Crown∞Ω Ultimate Certified)"
path: "docs/analyses/archaeology/datasets/cultural-landscapes/regions/flint-hills-region/provenance/README.md"
version: "v11.2.3"
...
intent: "cultural-landscape-region-flint-hills-provenance-refs"
...
# 🧬 **KFM — Flint Hills Eco-Cultural Landscape Region · Provenance Refs**  
`docs/analyses/archaeology/datasets/cultural-landscapes/regions/flint-hills-region/provenance/README.md`

**Purpose:**  
Define and govern the **region-local provenance reference layer** for the **Flint Hills Eco-Cultural Landscape Region**.  
...
This `provenance/` directory is the **Flint Hills–specific view** of KFM’s provenance system.
...
~~~text
docs/analyses/archaeology/datasets/cultural-landscapes/regions/flint-hills-region/provenance/
├── 📄 README.md                                 # This file (region-local provenance ref contract)
└── 🧬 flint-hills-region-v1.prov-ref.json       # Thin reference → canonical PROV-O provenance log(s)
~~~
...
- `region_slug` must be `"flint-hills-region"`.  
...
- CARE fields in refs (`care:sensitivity`, `care:review`, `care:visibility_rules`) must **match**:
  - Canonical PROV-O logs for the Flint Hills region.  
...
3. **Region Metadata Registry & Per-Region Metadata**  
   ...
   - Per-region: `../metadata/dcat-flint-hills-region-v1.jsonld`

**Contract:**

- The global **region-provenance-index** must include an entry for `flint-hills-region`.  
...
- `region_slug` matches `flint-hills-region`.  
...
- Optionally consult local ref files like `flint-hills-region-v1.prov-ref.json` for:
...
- Quickly resolve which canonical provenance log(s) back each Flint Hills regional overlay.  
- Enforce CARE visibility rules when rendering the region in map panels.  
...
When adding or updating provenance for the Flint Hills region:

1. **Update Canonical Provenance**  
   - Edit or add PROV-O JSON-LD under:  
     `docs/analyses/archaeology/datasets/cultural-landscapes/provenance/flint-hills-region-*.json`
...
4. **Update Local Ref JSON**  
   - Edit `flint-hills-region-v1.prov-ref.json` (or bump version) to:
     - List correct `canonical_provenance_paths`.  
     - Update CARE fields and `last_review_date` as needed.

5. **Run Local Validation**  
   - Use repo tooling (e.g., `make validate-region-flint-hills-provenance-refs`) to run schema and cross-link checks.
...
|----------|------------|---------------------------------------------|-------------------------------------------------------------------------|
| v11.2.3  | 2025-12-02 | Cultural Landscape WG · FAIR+CARE Council   | Created Flint Hills region-local provenance ref layout; defined ref JSON contract, CARE/sovereignty safeguards, and CI linkage to global provenance and registries; aligned with KFM-MDP v11.2.2. |
...
[⬅ Back to Flint Hills Eco-Cultural Region](../README.md) · [⬅ Back to Flint Hills Region Metadata](../metadata/README.md) · [⬅ Back to Global Region Provenance Registry](../../provenance/README.md)
