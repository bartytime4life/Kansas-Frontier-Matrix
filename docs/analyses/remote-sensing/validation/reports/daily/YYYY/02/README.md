---
title: "🗓️ KFM — Remote Sensing Validation Daily Reports YYYY-02 Index"
path: "docs/analyses/remote-sensing/validation/reports/daily/YYYY/02/README.md"
...
intent: "remote-sensing-validation-daily-reports-month-index-YYYY-02"
audience:
...
doc_uuid: "urn:kfm:doc:analyses:remote-sensing:validation:reports:daily:month-index:YYYY-02:v11.2.6"
semantic_document_id: "kfm-remote-sensing-validation-daily-reports-YYYY-02"
event_source_id: "ledger:docs/analyses/remote-sensing/validation/reports/daily/YYYY/02/README.md"
...
# 🗓️ **KFM — Remote Sensing Validation Daily Reports YYYY-02**
`docs/analyses/remote-sensing/validation/reports/daily/YYYY/02/README.md`

**Purpose**  
Month index and conventions for **daily** remote-sensing validation rollups for February (`02`) of year `YYYY`.
...
This folder is the **February** month index within a given year’s daily validation reports.
...
~~~text
📁 docs/analyses/remote-sensing/validation/reports/daily/YYYY/02/
├── 📄 README.md                                               — This month index (you are here)
├── 📄 YYYY-02-01.summary.json                                  — Daily summary (machine, small)
├── 📄 YYYY-02-01.summary.md                                    — Daily summary (human, optional)
├── 📄 YYYY-02-01.refs.json                                     — References only (optional)
├── 📄 YYYY-02-02.summary.json
├── 📄 YYYY-02-02.summary.md
├── 📄 YYYY-02-02.refs.json
└── …
~~~
...
Each `YYYY-02-DD.summary.json` SHOULD include:
...
|--------:|------------|---------|
| v11.2.6 | 2025-12-14 | Initial governed February month-index README template for daily remote-sensing validation reports; standardized naming, minimum content, determinism rules, and governance-safe publication posture. |
