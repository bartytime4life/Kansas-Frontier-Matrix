...
flowchart TD
  ...
  Q --> OPS[Ops Notification<br/>Slack / Email]
  Q --> F[Prefect Flow:<br/>kfm_schema_drift_steward]
  ...
  F --> PR[Task: Promote Patch to Prod<br/>(if safe)]
  F --> EM[Task: Emit Telemetry + PROV<br/>+ Governance Events]
