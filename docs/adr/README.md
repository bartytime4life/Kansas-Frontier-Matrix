...
The ratification base is `main@67f1d7eac9baabd69da997ba569de54c6b7c1d11`. PR #1763 added ADR-0029 as proposed; the current synchronized ratification change records it as the first accepted numbered ADR.
