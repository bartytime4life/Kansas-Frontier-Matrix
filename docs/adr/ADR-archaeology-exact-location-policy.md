# ADR Archaeology Exact Location Policy

**Status:** PROPOSED scaffold.  
**Source:** `docs/domains/archaeology/SOURCE_REGISTRY.md`  
**Referenced path:** `docs/adr/ADR-archaeology-exact-location-policy.md`
