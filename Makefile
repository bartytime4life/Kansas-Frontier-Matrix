...
trust-spine-baseline:
	...
	$(KFM_VALIDATION_ENV) python tools/validators/validate_generated_receipt.py data/receipts/generated/genrec-control-plane-registry-packet-review-fix-20260822.json --repo-root .
