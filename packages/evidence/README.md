...
<p>
  ...
  <a href="#package-purpose-and-disposition"><img alt="Purpose: decision required" src="https://img.shields.io/badge/purpose-decision%20required-f59e0b?style=flat-square"></a>
  <a href="#validation-layers"><img alt="Shape validation: wired" src="https://img.shields.io/badge/shape%20validation-wired-2da44e?style=flat-square"></a>
  <a href="#resolution-policy-and-release-boundary"><img alt="Resolution: held" src="https://img.shields.io/badge/resolution-held-8250df?style=flat-square"></a>
  <a href="#trust-flow"><img alt="Truth posture: cite or abstain" src="https://img.shields.io/badge/truth-cite%20or%20abstain-b42318?style=flat-square"></a>
</p>
...
```mermaid
flowchart LR
    INPUTS["explicit governed inputs"] --> COMPOSE["packages/evidence candidate composition"]
    CONTRACTS["contracts/evidence meaning"] -. constrains .-> COMPOSE
    SCHEMAS["schemas/contracts/v1/evidence shape"] -. validates .-> COMPOSE
    ID["identity helpers"] --> COMPOSE
    HASH["hashing helpers"] --> COMPOSE
    CITE["citation helpers"] --> COMPOSE

    COMPOSE --> SHAPE["schema validation"]
    SHAPE --> RESOLVE["governed resolution / membership / current-head checks"]
    RESOLVE --> POLICY["rights / sensitivity / admissibility policy"]
    POLICY --> REVIEW["review and evidence closure"]
    REVIEW --> RELEASE["release / correction / rollback"]
    RELEASE --> API["governed API / released projection"]
    API --> PUBLIC["map / drawer / focus / export / review UI"]

    COMPOSE -. forbidden .-> PROOF["proof storage"]
    COMPOSE -. forbidden .-> PUBLIC
    COMPOSE -. forbidden .-> RUNTIME["model runtime / internal stores"]
```
