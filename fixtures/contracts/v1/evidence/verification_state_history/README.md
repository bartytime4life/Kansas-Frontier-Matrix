...
The valid lane covers a late-recorded correction followed by re-verification and supersession, plus revocation followed by re-verification. The invalid lane covers missing conditional shape, broken chain linkage, an effective time after recorded time, an impossible UTC timestamp, hash mismatch, append-order drift, and a prohibited transition after supersession.
