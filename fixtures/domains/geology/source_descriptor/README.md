# Geology SourceDescriptor fixtures

Fixtures for `tools/validators/domains/geology/validate_source_descriptor.py`'s
...
must include `"geology"` when declared.

- `valid/valid_1.json` is a real committed fixture (`fixtures/contracts/v1/source/source_descriptor/valid/valid_ku_news_gmd3_aem_announcement_2026_05_11.json`) already scoped to geology (among other domains).
