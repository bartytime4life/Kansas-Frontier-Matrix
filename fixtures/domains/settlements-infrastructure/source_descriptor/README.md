# Settlements/Infrastructure SourceDescriptor fixtures

Fixtures for `tools/validators/domains/settlements-infrastructure/validate_source_descriptor.py`'s
...
must include `"settlements-infrastructure"` when declared.

- `valid/valid_1.json` is a real committed fixture (`fixtures/contracts/v1/source/source_descriptor/valid/valid_dasc_plss.json`) already scoped to settlements-infrastructure.
