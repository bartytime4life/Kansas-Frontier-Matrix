# Agriculture SourceDescriptor fixtures

Fixtures for `tools/validators/domains/agriculture/validate_source_descriptor.py`'s
...
must include `"agriculture"` when declared.

- `valid/valid_1.json` is a real committed fixture (`fixtures/contracts/v1/source/source_descriptor/valid/valid_usdm_inactive.json`) already scoped to agriculture (among other domains).
