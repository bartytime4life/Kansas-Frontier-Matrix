# Soil SourceDescriptor fixtures

Fixtures for `tools/validators/domains/soil/validate_source_descriptor.py`'s
...
must include `"soil"` when declared.

- `valid/valid_1.json` is a real committed fixture (`fixtures/contracts/v1/source/source_descriptor/valid/valid_2.json`) already scoped to soil.
