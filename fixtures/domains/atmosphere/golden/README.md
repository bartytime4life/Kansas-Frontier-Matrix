# Atmosphere golden fixtures

`fixtures/domains/atmosphere/golden/`

Status: draft / fixture lane.

This directory is for stable expected-output Atmosphere fixture examples used by bounded tests or documentation examples. These files are examples only and are not authoritative project records.
...
- Keep each golden fixture tied to a known test, validator, no-network check, helper, or documentation example.
