# Atmosphere SourceDescriptor fixtures

Fixtures for `tools/validators/domains/atmosphere/validate_source_descriptor.py`'s
...
must include `"atmosphere"` when declared.
