...
- Fixture payload inventory: `invalid_1_modeled_labeled_observed.json` / `.expected_error.txt` added — a claim with `source_character: modeled` displayed as `observed`.
