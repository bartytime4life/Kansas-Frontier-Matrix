...
- Fixture payload inventory: `invalid_1_regulatory_labeled_observed.json` / `.expected_error.txt` added — a claim with `source_character: regulatory` displayed as `observed`.
