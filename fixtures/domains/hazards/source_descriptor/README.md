# Hazards SourceDescriptor fixtures

Fixtures for `tools/validators/domains/hazards/validate_source_descriptor.py`'s
...
must include `"hazards"` when declared.

- `valid/valid_1.json` is a real committed fixture (`fixtures/contracts/v1/source/source_descriptor/valid/valid_kdhe_hab_inactive.json`) already scoped to hazards.
