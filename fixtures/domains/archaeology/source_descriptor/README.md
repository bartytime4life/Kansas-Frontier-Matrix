# Archaeology SourceDescriptor fixtures

Fixtures for `tools/validators/domains/archaeology/validate_source_descriptor.py`'s
...
must include `"archaeology"` when declared.
