...
- Fixture payload inventory: `valid_1_restricted_public_safe.json` added — a synthetic restricted rare-plant record with a withheld-precision public derivative.
