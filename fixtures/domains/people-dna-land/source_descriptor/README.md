# People/DNA/Land SourceDescriptor fixtures

Fixtures for `tools/validators/domains/people-dna-land/validate_source_descriptor.py`'s
...
must include `"people-dna-land"` when declared.
