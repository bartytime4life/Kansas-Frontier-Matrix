# `release/rollback_cards/settlements-infrastructure/` — Settlement Systems Rollback Cards

<!-- [KFM_META_BLOCK_V2]
doc_id: kfm://doc/release-rollback-cards-settlements-infrastructure-readme
title: release/rollback_cards/settlements-infrastructure/ — Settlement Systems Rollback Cards
version: v1
status: draft
policy_label: public
owners:
  ...
  - <docs-steward>
updated: 2026-07-03
tags: [kfm, release, rollback-cards, settlement-systems, correction, review]
[/KFM_META_BLOCK_V2] -->
...
`release/rollback_cards/settlements-infrastructure/` holds compact rollback cards for the settlement systems release lane.
...
| Field | Value |
|---|---|
| Document type | Settlement systems rollback-card README |
| Owning root | `release/` |
| Lane | `release/rollback_cards/settlements-infrastructure/` |
| Status | Draft |
...
| Required reviewers | Settlement systems steward, release steward, rollback steward, data steward, and docs steward; policy reviewer when needed. |
...
| Scope | State the settlement systems release family, artifact family, layer family, geography, time slice, or release target. |
...
- Settlement systems rollback cards.
...
```text
<YYYY-MM-DD>_<settlement-systems-scope>_rollback-card.md
```

Examples:

```text
2026-07-03_settlement-systems-summary_rollback-card.md
2026-07-03_settlement-systems-public-surface_rollback-card.md
2026-07-03_settlement-systems-validation-posture_rollback-card.md
```
...
- [ ] Expand `release/rollback_cards/README.md` so this settlement systems lane inherits from a complete parent contract.
- [ ] Confirm whether rollback cards are distinct from full rollback review records under `release/rollback/`.
- [ ] Confirm CODEOWNERS for `release/rollback_cards/settlements-infrastructure/`.
...
| Next review trigger | Parent rollback-card lane expansion, first settlement systems rollback card, full rollback review, correction, notice, changelog update, or release-state change |
