# `release/candidates/hazards/` — Hazards Candidate Review Lane

<!-- [KFM_META_BLOCK_V2]
doc_id: kfm://doc/release-candidates-hazards-readme
title: release/candidates/hazards/ — Hazards Candidate Review Lane
version: v1
status: draft
policy_label: public
owners:
  ...
  - <data-steward>
updated: 2026-07-03
tags: [kfm, release, candidates, hazards, pre-publication, review, validation, rollback]
[/KFM_META_BLOCK_V2] -->
...
This directory holds draft review notes for hazards release candidates.
...
| Field | Value |
|---|---|
| Document type | Hazards release-candidate README |
| Owning root | `release/` |
| Candidate lane | `release/candidates/hazards/` |
| Status | Draft |
...
| Required reviewers | Hazards steward, release steward, and data steward; policy/sensitivity reviewer when needed. |
...
- Hazards candidate notes.
- Readiness checklists.
- Review summaries.
- Links to source, evidence, validation, policy, manifest, correction, and rollback records.
- Time-validity and update-cadence notes for hazard products.
- Promote, defer, repair, or withdraw notes.
- Sublane indexes for hazard candidate families.
...
## Candidate scope
<hazard type, geography, time window, and intended release surface>
...
## Time validity
<observation, model, forecast, update, or stale-state notes>
...
- [ ] Confirm hazards candidate naming convention.
- [ ] Confirm processed and published artifact paths.
- [ ] Confirm ReleaseManifest path or schema.
- [ ] Confirm stale-state and time-validity rules for hazards candidates.
- [ ] Confirm correction and rollback record paths.
- [ ] Confirm whether hazards need sublanes for flood, fire, severe weather, drought, geologic hazard, or other candidate families.
...
| Next review trigger | First hazards candidate dossier, new sublane, manifest handoff, or release decision |
