# `release/candidates/people/` — People Candidate Review Lane

<!-- [KFM_META_BLOCK_V2]
doc_id: kfm://doc/release-candidates-people-readme
title: release/candidates/people/ — People Candidate Review Lane
version: v1
status: draft
policy_label: public
owners:
...
updated: 2026-07-03
tags: [kfm, release, candidates, people, pre-publication, review, validation, rollback]
[/KFM_META_BLOCK_V2] -->
...
This directory holds draft review notes for people-domain release candidates.
...
| Field | Value |
|---|---|
| Document type | People release-candidate README |
| Owning root | `release/` |
| Candidate lane | `release/candidates/people/` |
| Status | Draft |
...
| Required reviewers | People steward, release steward, data steward, and policy/privacy reviewer. |
...
- People-domain candidate notes.
- Readiness checklists.
- Review summaries.
- Links to source, evidence, validation, policy, manifest, correction, and rollback records.
- Rights, privacy, attribution, consent, and public-surface review notes.
- Promote, defer, repair, block, or withdraw notes.
- Sublane indexes for people candidate families.
...
- Bulk datasets, person-level exports, tiles, API payloads, or map-ready artifacts.
- Source descriptors, schemas, contracts, policy rules, or validator code.
- Personal records, living-person records, private family records, or direct identity payloads.
...
- Rights, attribution, and consent status
...
## Candidate scope
<people-domain scope, geography, time window, and intended release surface>
...
## Rights, attribution, consent, and privacy status
<status and blockers>
...
- [ ] Confirm people candidate naming convention.
- [ ] Confirm processed and published artifact paths.
- [ ] Confirm ReleaseManifest path or schema.
- [ ] Confirm policy/privacy review requirements for people candidates.
- [ ] Confirm correction and rollback record paths.
- [ ] Confirm whether people needs sublanes for biography, organizations, census, families, historical persons, or other candidate families.
...
| Next review trigger | First people candidate dossier, new sublane, manifest handoff, or release decision |
