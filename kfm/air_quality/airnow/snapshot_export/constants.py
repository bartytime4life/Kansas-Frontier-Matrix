...
MANIFEST_FORBIDDEN_KEY_TERMS=("api_key","token","secret","password","bearer","credential","authorization","private_key","session","webhook","publish_url","github_token","bucket","storage_account","connection_string","legal_hold_id","archive_endpoint","transfer_endpoint","snapshot_endpoint","release_endpoint")
FORBIDDEN_MEMBER_TERMS=("publish","release","upload","serve","dashboard","tiles","public_api","emergency_alert","regulatory_claim","external_storage","delete","destroy","shred","chmod","chattr","legal_hold","archive_certification","final_accession","snapshot_release","snapshot_publish")
REQUIRED_LAYER15_KEYS=["archival_finalization_receipt","archival_decision_candidate","archival_acceptance_consolidation","archival_blocker_consolidation","archival_non_execution_attestation","archival_policy_continuity_matrix","archival_caveat_continuity_register"]
