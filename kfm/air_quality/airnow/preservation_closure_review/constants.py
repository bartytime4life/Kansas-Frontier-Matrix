...
REQUIRED_LAYER24_KEYS=["preservation_closure_receipt","preservation_closure_readiness_matrix","preservation_closure_candidate_ledger","unresolved_preservation_issue_register","preservation_governance_closure_gate","preservation_receipt_closure_verification_matrix","preservation_evidence_closure_summary","preservation_policy_closure_continuity_matrix","preservation_caveat_closure_continuity_register","preservation_closure_non_execution_attestation","preservation_closure_decision_candidate"]
L24_DENIED_TRUE_FIELDS=["publication_allowed","public_release_allowed","closure_execution_allowed","task_closure_allowed","audit_closure_allowed","governance_closure_allowed","preservation_actions_executed","preservation_copy_executed","preservation_transfer_executed","snapshot_export_executed","snapshot_copy_executed","snapshot_transfer_executed","snapshot_published","snapshot_released","archive_transfer_allowed","file_deletion_allowed","legal_hold_creation_allowed","official_archive_certification_allowed","command_execution_allowed","final_accession_execution_allowed"]
EVIDENCE_TYPES=["CLOSURE_READINESS_REVIEW_NOTE","CLOSURE_CANDIDATE_REVIEW_NOTE","UNRESOLVED_ISSUE_REVIEW_NOTE","GOVERNANCE_GATE_REVIEW_NOTE","RECEIPT_VERIFICATION_REVIEW_NOTE","EVIDENCE_SUMMARY_REVIEW_NOTE","POLICY_CONTINUITY_REVIEW_NOTE","CAVEAT_CONTINUITY_REVIEW_NOTE","NON_EXECUTION_REVIEW_NOTE","MANUAL_PRESERVATION_CLOSURE_REVIEW_ATTESTATION"]
INTERNAL_DISCLAIMER="Internal-only manual preservation closure review"
FORBIDDEN_TEXT_TERMS=("closure execution","task closure","audit closure","governance closure","preservation execution","preservation copy","preservation transfer","snapshot export","snapshot copy","snapshot transfer","publication approved","public release","file deletion","legal hold","legal advice","official certification")
