...
title: `examples/habitat/` — Habitat Domain Examples
...
current_path: examples/habitat/README.md
...
evidence_snapshot:
  ...
  prior_blob: 44057b2bc13f31545fb033e3e1584e675f1853ea
...
# `examples/habitat/` — Habitat Domain Examples

> **One-line purpose.** Teach public-safe Habitat context, patch, land-cover, ecoregion, suitability, connectivity, restoration-opportunity, and sensitive-join behavior.
...
Teach public-safe Habitat context, patch, land-cover, ecoregion, suitability, connectivity, restoration-opportunity, and sensitive-join behavior.
...
**Non-authoritative Habitat example lane; domain, lifecycle, proof, policy, and release authority remain in their owning roots.**
...
| Prior blob | `44057b2bc13f31545fb033e3e1584e675f1853ea` |
| Recursive payload inventory | `CONFIRMED` — README and `suitability_not_occurrence.walkthrough.md` in this checkout |
| Executable entrypoint / observed run | `NOT ESTABLISHED` |
| Public/release readiness | `DENY BY PLACEMENT` |

## What belongs here

- synthetic HabitatPatch and context examples
- land-cover and ecoregion examples with source-role and crosswalk caveats
- suitability-not-occurrence and connectivity-not-movement demonstrations
- restoration-opportunity-not-prescription examples
- negative examples for rare species, rare plants, archaeology, private land, and infrastructure joins
...
|---|---|
| real Habitat source or lifecycle payloads | `data/<phase>/habitat/` |
| operational catalog, proof, receipt, published layer, or release objects | `data/catalog/`, `data/proofs/`, `data/receipts/`, `data/published/`, and `release/` |
| schemas, contracts, policy, validators, tests, fixtures, or implementation code | their canonical responsibility roots |
| exact sensitive occurrence or cross-lane joins | generalize, redact, restrict, delay, quarantine, or deny |
| management prescriptions or regulatory determinations | owning agencies and governed evidence/release paths |

## Inputs

Habitat doctrine, verified operational references, synthetic geometry, source-role labels, and example evidence/policy states.
...
Static synthetic Habitat demonstrations with explicit model/context limitations and finite outcomes.
...
- Confirm suitability is not occurrence and HabitatPatch is not critical-habitat designation.
- Confirm land cover is context, not Habitat, Fauna, Flora, Soil, Hydrology, or regulatory truth by itself.
- Confirm sensitive joins are synthetic/generalized/denied.
- Confirm cross-domain ownership remains visible.
- Validate links, examples, guardrails, and finite outcomes.
...
Examples/docs, Habitat, evidence, policy/sensitivity, release, and any referenced domain steward.
...
- [Habitat doctrine](../../docs/domains/habitat/README.md)
- [Habitat RAW lane](../../data/raw/habitat/README.md)
- [Habitat processed lane](../../data/processed/habitat/README.md)
- [Habitat published layers](../../data/published/layers/habitat/README.md)

## ADRs

Sensitive-domain deny-by-default and public-internal separation decisions are relevant. This lane does not decide or accept them.
...
| Risk | Guardrail |
|---|---|
| Suitability becomes occurrence truth | Label it modeled/contextual and require evidence for occurrence claims. |
| Connectivity becomes movement truth | Treat corridors as derived interpretations. |
| Restoration opportunity becomes prescription | Keep review-aid and non-advisory posture. |
| Cross-lane sensitive join leaks | Fail closed and preserve owning-lane truth. |

## Current bounded inventory

The recursive subtree contains this README and [`suitability_not_occurrence.walkthrough.md`](suitability_not_occurrence.walkthrough.md), a synthetic Habitat/Fauna boundary walkthrough with expected `ABSTAIN`.
