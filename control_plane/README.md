...
| [`object-family-register`](https://github.com/bartytime4life/Kansas-Frontier-Matrix/actions/runs/34015364272) | 34015364272 | `PASS` | The dedicated object-family profile passed; this does not resolve the projection's 10 conflicted required families. |
...
| [`object_family_register.yaml`](object_family_register.yaml) | 19 entries | dedicated schema | Dedicated current-main profile passes; the projection declares 10 conflicted required families. No object-family authority. |
