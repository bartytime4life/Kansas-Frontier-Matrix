...
[![Child registers: 0 of 7 confirmed](https://img.shields.io/badge/child%20registers-0%20of%207%20confirmed-f59e0b?style=flat-square)](#current-bounded-inventory)
...
```mermaid
flowchart LR
    D["Habitat doctrine<br/>docs/domains/habitat/"]
    C["Object meaning<br/>contracts/domains/habitat/"]
    S["Machine shape<br/>schemas/contracts/v1/domains/habitat/"]
    P["Admissibility<br/>policy/domains/habitat/"]
    E["Evidence, tests, release,<br/>correction, rollback"]
    I["Habitat control-plane index<br/>control_plane/domains/habitat/"]
    R["Admitted internal consumers<br/>validators · review tooling"]
    G["Governed API + released artifacts<br/>ordinary public path"]
    ...
    P --> I
    E --> I
    I -->|"resolvable pointers only"| R
    E --> G
    R -. "must not publish" .-> G

    classDef authority fill:#e3f2fd,stroke:#1565c0,color:#0d47a1
    classDef index fill:#fff3e0,stroke:#ef6c00,color:#e65100
    classDef consumer fill:#e8f5e9,stroke:#2e7d32,color:#1b5e20
    class D,C,S,P,E authority
    class I index
    class R,G consumer
```
