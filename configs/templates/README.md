...
> [!IMPORTANT]
> **Current posture:** draft / `NEEDS VERIFICATION` for consumer binding and validation. The directory listing and five payload files are `CONFIRMED` at `main@b5a91a33b6c900033364fe924a74a907745a6d2d`. No template-specific consumer or validator is claimed by this README.
