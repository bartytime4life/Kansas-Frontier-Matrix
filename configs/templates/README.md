...
> [!IMPORTANT]
> **Current posture:** draft / `NEEDS VERIFICATION` for consumer binding and validation. The directory listing and five payload files are `CONFIRMED` at `main@7cbb5e771834c07465c0270efcb32d9dd4329cc2`. No template-specific consumer or validator is claimed by this README.
