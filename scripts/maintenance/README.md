...
| `run_doctrine_artifact_preflight.py` | Orchestrate checker + renderer and print a single summary payload for CI/operator use (timestamped receipts by default; `--stable-filenames` for deterministic names). | `0=preflight executed`, `1=strict missing-artifact fail`, `2=execution/validation error` |
