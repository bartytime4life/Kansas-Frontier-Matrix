#!/usr/bin/env python3
"""Evaluate the MapLibre GL JS 6.9 readiness candidate without installing MapLibre.
...
A ``READY`` result is eligibility evidence for human review of the exact 6.9.0
...
PROFILE = "kfm-maplibre-v6-9-readiness-v5"
TARGET_VERSION = "6.9.0"
UPSTREAM_TAG_COMMIT = "f985318d1fa7e01d8b7e32a719aaf91efcb348d4"
PROBE_NAMES = (
