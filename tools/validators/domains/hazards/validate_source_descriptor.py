#!/usr/bin/env python3
"""Validate Hazards source admission through the shared SourceDescriptor profile,
...
"hazards" in that scope; otherwise the descriptor does not claim to apply
...
FIXTURES_DIR = REPO_ROOT / "fixtures/domains/hazards/source_descriptor"
