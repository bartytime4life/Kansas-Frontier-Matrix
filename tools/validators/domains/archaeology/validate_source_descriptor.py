#!/usr/bin/env python3
"""Validate Archaeology source admission through the shared SourceDescriptor profile,
...
"archaeology" in that scope; otherwise the descriptor does not claim to apply
...
FIXTURES_DIR = REPO_ROOT / "fixtures/domains/archaeology/source_descriptor"
