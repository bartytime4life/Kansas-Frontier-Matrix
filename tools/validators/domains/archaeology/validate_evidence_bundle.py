...
SCHEMA = ROOT / "schemas/contracts/v1/domains/archaeology/evidence_bundle.schema.json"
...
def main(argv: list[str] | None = None) -> int:
    """Validate Archaeology EvidenceBundle projections against shared fixtures/files."""
