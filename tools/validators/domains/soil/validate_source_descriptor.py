#!/usr/bin/env python3
"""Validate Soil source admission through the shared SourceDescriptor profile,
...
"soil" in that scope; otherwise the descriptor does not claim to apply
...
FIXTURES_DIR = REPO_ROOT / "fixtures/domains/soil/source_descriptor"
