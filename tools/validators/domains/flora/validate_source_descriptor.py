#!/usr/bin/env python3
"""Validate Flora source admission through the shared SourceDescriptor profile,
...
"flora" in that scope; otherwise the descriptor does not claim to apply
...
FIXTURES_DIR = REPO_ROOT / "fixtures/domains/flora/source_descriptor"
