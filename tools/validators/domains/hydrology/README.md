...
notes:
  ...
  - "The bounded synthetic WaterLevelObservation fixture profile binds record identity to its generalized gauge, datum, source descriptor, and observation time and requires concrete lowercase canonical fixture identifiers for its source, gauge, at most 32 unique canonically ordered evidence receipts, and datum references; evidence receipts bind the water-level family, governed gauge, observation time, datum, and source descriptor, while timestamp-shaped segments are reserved case-insensitively and admitted only as calendar-valid exact ASCII-digit YYYYMMDDTHHMMSSZ tokens. It creates no live-source, release, flood-warning, or publication authority."
[/KFM_META_BLOCK_V2] -->
