#!/usr/bin/env python3
"""Validate the Geology projection of the shared EvidenceBundle shape.

This bounded domain entrypoint delegates structural validation to KFM's shared
JSON Schema runner. It does not define independent evidence semantics or
authorize policy, release, publication, source admission, or exact subsurface
disclosure.
"""
...
SCHEMA_PATH = (
    REPO_ROOT / "schemas/contracts/v1/domains/geology/evidence_bundle.schema.json"
)
