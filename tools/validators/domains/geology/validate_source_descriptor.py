#!/usr/bin/env python3
"""Validate Geology source admission through the shared SourceDescriptor profile,
...
"geology" in that scope; otherwise the descriptor does not claim to apply
...
FIXTURES_DIR = REPO_ROOT / "fixtures/domains/geology/source_descriptor"
