#!/usr/bin/env python3
"""Validate Fauna source admission through the shared SourceDescriptor profile,
...
"fauna" in that scope; otherwise the descriptor does not claim to apply
...
FIXTURES_DIR = REPO_ROOT / "fixtures/domains/fauna/source_descriptor"
