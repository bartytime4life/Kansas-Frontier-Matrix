#!/usr/bin/env python3
"""Validate Roads/Rail/Trade source admission through the shared SourceDescriptor profile,
...
"roads-rail-trade" in that scope; otherwise the descriptor does not claim to apply
...
FIXTURES_DIR = REPO_ROOT / "fixtures/domains/roads-rail-trade/source_descriptor"
