...
SCHEMA = ROOT / "schemas/contracts/v1/domains/roads-rail-trade/evidence_bundle.schema.json"
...
def main(argv: list[str] | None = None) -> int:
    """Validate Roads/Rail/Trade EvidenceBundle projections against shared fixtures/files."""
