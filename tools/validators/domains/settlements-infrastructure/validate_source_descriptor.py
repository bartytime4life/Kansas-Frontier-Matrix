#!/usr/bin/env python3
"""Validate Settlements/Infrastructure source admission through the shared SourceDescriptor profile,
...
"settlements-infrastructure" in that scope; otherwise the descriptor does not claim to apply
...
FIXTURES_DIR = REPO_ROOT / "fixtures/domains/settlements-infrastructure/source_descriptor"
