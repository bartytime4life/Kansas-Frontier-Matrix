...
SCHEMA = ROOT / "schemas/contracts/v1/domains/settlements-infrastructure/evidence_bundle.schema.json"
...
def main(argv: list[str] | None = None) -> int:
    """Validate Settlements/Infrastructure EvidenceBundle projections against shared fixtures/files."""
