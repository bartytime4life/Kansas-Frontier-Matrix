#!/usr/bin/env python3
"""Validate the Atmosphere projection of the shared EvidenceBundle shape.
...
policy, release, publication, or emergency use.
"""
...
SCHEMA_PATH = (
    REPO_ROOT
    / "schemas/contracts/v1/domains/atmosphere/evidence_bundle.schema.json"
)
