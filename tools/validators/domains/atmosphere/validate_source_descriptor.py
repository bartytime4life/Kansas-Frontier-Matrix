#!/usr/bin/env python3
"""Validate Atmosphere source admission through the shared SourceDescriptor profile,
...
"atmosphere" in that scope; otherwise the descriptor does not claim to apply
...
FIXTURES_DIR = REPO_ROOT / "fixtures/domains/atmosphere/source_descriptor"
