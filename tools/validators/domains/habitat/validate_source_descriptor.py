#!/usr/bin/env python3
"""Validate Habitat source admission through the shared SourceDescriptor profile,
...
"habitat" in that scope; otherwise the descriptor does not claim to apply
...
FIXTURES_DIR = REPO_ROOT / "fixtures/domains/habitat/source_descriptor"
