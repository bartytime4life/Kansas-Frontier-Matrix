...
SCHEMA = ROOT / "schemas/contracts/v1/domains/agriculture/evidence_bundle.schema.json"
...
def main(argv: list[str] | None = None) -> int:
    """Validate Agriculture EvidenceBundle projections against shared fixtures/files."""
