...
from kfm.air_quality.airnow.closure_archive_index_review import run_closure_archive_index_review
...
def main() -> int:
    ...
    a=ap.parse_args()
    try:
        r=run_closure_archive_index_review(a.manifest,a.out_dir,a.created_at)
