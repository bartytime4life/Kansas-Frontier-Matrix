...
from kfm.air_quality.airnow.preservation_closure.run_preservation_closure_readiness import run_preservation_closure_readiness
...
def main():
 ...
 r=run_preservation_closure_readiness(a.manifest,a.out_dir,a.created_at)
